...
namespace gpnaucrates
{
	...
	class CStatisticsUtils
	{
		...
		public:
			...
			static
			ULONG GetColId(const CStatsPredPtrArry *stats_preds_array);
			...
			static
			void PrintHistogramMap(IOstream &os, UlongToHistogramMap *col_histogram_mapping);
#endif // GPOS_DEBUG
			...
			static
			CDouble GetNumDistinct(const CBucketArray *histogram_buckets);

			// return the cumulative frequency in the given array of buckets
			static
			CDouble GetFrequency(const CBucketArray *histogram_buckets);
