...
/*
 * Populates the global variable 'input' with a randomly
 * generated string of length 'size'.
 */
void
...
/* ==================== compress_string =================== */
/*
 * Tests that compress_string uses palloc() to allocate memory
...
/* ==================== uncompress_string =================== */
/*
 * Tests that uncompress_string uses palloc() to allocate memory
 * for zlib internal buffers.
 * This test uses the compressed string generated by the
 * first test as an input, so it must run after it.
 */
void
test__uncompress_string__palloc_uncompress(void **state)
{
	...
	/*
	 * compressedOutput must be already initialized by running the
	 * test__compress_string__palloc_compress test first.
	 */
	assert_true(NULL != compressedString);
	...
	char *output = uncompress_string(compressedString, compressed_size,
			&uncompressed_size);
