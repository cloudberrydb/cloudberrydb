...
test__MemoryAccounting_GetAccountName__Validate(void **state)
{
	...
	char* shortLivingNames[] = {"Top", "Main", "Parser", "Planner", "PlannerHook", "Dispatcher", "Serializer", "Deserializer",
			...
			"X_Limit", "X_Motion", "X_ShareInputScan", "X_WindowAgg", "X_Repeat", "X_ModifyTable", "X_LockRows", "X_SplitUpdate", "X_RowTrigger",
			"X_AssertOp", "X_PartitionSelector", "X_RecursiveUnion", "X_CteScan", "X_WorkTableScan", "X_ForeignScan", "X_CustomScan", "X_NestedExecutor"};
