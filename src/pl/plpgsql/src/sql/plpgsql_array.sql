...
-- GPDB has its own builtin complex type, use public schema.
create type public.complex as (r float8, i float8);
create type quadarray as (c1 public.complex[], c2 public.complex);
