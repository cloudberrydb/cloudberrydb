...
select segment_file_num, mirror_append_only_new_eof from gp_dist_random('gp_persistent_relation_node') where relfilenode_oid = 'uaocs_table_check_eof_after_delete'::regclass and mirror_append_only_new_eof != 0;
...
select segment_file_num, mirror_append_only_new_eof from gp_dist_random('gp_persistent_relation_node') where relfilenode_oid = 'uaocs_table_check_eof_after_update'::regclass and mirror_append_only_new_eof != 0;
