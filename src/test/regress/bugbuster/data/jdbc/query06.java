...
public class query06 {
  ...
  Statement s = null;
    ...
    try {
      ...
      m = s.executeUpdate("create table tbl1(a int, b int) DISTRIBUTED BY (b)");
      ...
      m = s.executeUpdate("UPDATE tbl1 SET a=100 WHERE a=1");
      System.out.println("UPDATED ROWS "+m);
      rs = s.executeQuery("SELECT * FROM tbl1 ORDER BY b");
