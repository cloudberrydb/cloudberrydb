...
BEGIN
   i = startValue;
    EXECUTE 'INSERT INTO subt_plpgsql_t2 VALUES ('|| i ||', ''abc'', ("decode"(repeat(''1234567890'',10000),''escape'')))';
END;
$$
LANGUAGE PLPGSQL
;
...
create table subt_plpgsql_t2( a int, c varchar, c_junk bytea  default NULL);
BEGIN;
