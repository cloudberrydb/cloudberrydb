...
-- end_ignore
-- System level guc 'appendonly=true,orientation=column,compresstype=rle_type'
...
Create table ds_sy_t2 (i int, j int) with(compresstype=zlib, compresslevel=3, checksum=false, blocksize=8192);
