...
--
create table sync2_heap_alter_part_add_part1 (a char, b int, d char,e text) 
...
--
 insert into sync2_heap_alter_part_add_part1 values ('a',generate_series(1,5),'b','test_1');
--
-- SYNC2 Heap Part Table 2
--
create table sync2_heap_alter_part_add_part2 (a char, b int, d char,e text) 
partition by range (b)
subpartition by list (d)
subpartition template (
 subpartition sp1 values ('a'),
...
-- Insert few records into the table
--
 insert into sync2_heap_alter_part_add_part2 values ('a',generate_series(1,5),'b','test_1');
--
--
...
--
alter table sync1_heap_alter_part_add_part7 set subpartition template ();
--
-- Add Partition
--
...
-- Set subpartition Template
--
alter table ck_sync1_heap_alter_part_add_part6 set subpartition template ();
--
-- Add Partition
--
...
-- Set subpartition Template
--
alter table  ct_heap_alter_part_add_part4 set subpartition template ();
--
-- Add Partition
--
...
-- Set subpartition Template
--
alter table resync_heap_alter_part_add_part2 set subpartition template ();
--
-- Add Partition
--
...
-- Set subpartition Template
--
alter table sync2_heap_alter_part_add_part1 set subpartition template ();
--
-- Add Partition
--
