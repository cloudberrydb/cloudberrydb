-- start_igonre
Drop tablespace subt_tbsp_ao_new;
-- end_ignore
create tablespace subt_tbsp_ao_new filespace subt_filespace_a ;
BEGIN;

Savepoint sp1;
Drop table if exists subt_alter_table_ao1;
Create table subt_alter_table_ao1 (col0 int) with(appendonly=true) distributed randomly;
...
Alter table subt_alter_table_ao1 set tablespace subt_tbsp_ao_new;
