...
create table resync_reindex_vacuum_full_t1heap (c1 int, c2 char(100)) distributed by (c1);
insert into resync_reindex_vacuum_full_t1heap select generate_series(1,100000), 'abcdefg';
insert into resync_reindex_vacuum_full_t1heap values (112232, 'xyz');

delete from resync_reindex_vacuum_full_t1heap where c1 not in (1, 12, 45, 46, 112232);
