create tablespace abort_create_needed_ao_ts1 filespace filespace_test_a;
create tablespace abort_create_needed_ao_ts2 filespace filespace_test_a;
...
col032 date, col034 lseg,col035 point,col036 polygon,col037 real,col039 time, col040 timestamp) WITH (appendonly=true) tablespace abort_create_needed_ao_ts1;
