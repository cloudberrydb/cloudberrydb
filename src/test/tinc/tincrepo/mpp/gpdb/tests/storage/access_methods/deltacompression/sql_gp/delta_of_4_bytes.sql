...
-- start_ignore
Drop table if exists delta_4_byte;
-- end_ignore

Create table delta_4_byte(
    i int, 
    a1 integer, 
    a2 bigint, 
    a3 date, 
...
Insert into delta_4_byte values 
...
Select 'compression_ratio' as compr_ratio, get_ao_compression_ratio('delta_4_byte');

Select * from delta_4_byte order by a1;
