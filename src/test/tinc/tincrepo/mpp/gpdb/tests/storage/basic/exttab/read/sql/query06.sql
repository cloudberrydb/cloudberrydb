...
location ('file://@hostname@@gpfdist_datadir@/nation.tbl-dir/x*' )
...
location ('file://@hostname@@gpfdist_datadir@/region.tbl-dir' )
FORMAT 'text' (delimiter '|');
...
location ('file://@hostname@@gpfdist_datadir@/part.tbl-dir' )
FORMAT 'text' (delimiter '|');
...
location ('file://@hostname@@gpfdist_datadir@/supplier.tbl-dir' )
FORMAT 'text' (delimiter '|');
...
location ('file://@hostname@@gpfdist_datadir@/partsupp.tbl-dir/*' )
FORMAT 'text' (delimiter '|');
...
location ('file://@hostname@@gpfdist_datadir@/customer.tbl-dir' )
FORMAT 'text' (delimiter '|');
...
location ('file://@hostname@@gpfdist_datadir@/orders.tbl-dir' )
FORMAT 'text' (delimiter '|');
...
location ('file://@hostname@@gpfdist_datadir@/lineitem.tbl.g?' )
FORMAT 'text' (delimiter '|');
