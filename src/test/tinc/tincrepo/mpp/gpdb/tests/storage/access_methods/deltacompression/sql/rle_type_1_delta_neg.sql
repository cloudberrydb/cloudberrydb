...
Create table rle_type_1_delta_neg(
    a1 integer,
    a2 bigint,
    a3 date,
    a4 time,
...
select attrelid::regclass as relname, attnum, attoptions from pg_class c, pg_attribute_encoding e  where c.relname = 'rle_type_1_delta_neg'  and c.oid=e.attrelid  order by relname, attnum;

\d+ rle_type_1_delta_neg

Insert into rle_type_1_delta_neg values
...
Select 'compression_ratio' as compr_ratio, get_ao_compression_ratio('rle_type_1_delta_neg');

Select a1, a4, a5  from rle_type_1_delta_neg order by a1;
