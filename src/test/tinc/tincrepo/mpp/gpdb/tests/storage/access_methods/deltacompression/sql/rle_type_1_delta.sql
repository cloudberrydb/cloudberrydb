...
select attrelid::regclass as relname, attnum, attoptions from pg_class c, pg_attribute_encoding e  where c.relname = 'rle_type_1_delta'  and c.oid=e.attrelid  order by relname, attnum;

\d+ rle_type_1_delta


Insert into rle_type_1_delta values
...
Select 'compression_ratio' as compr_ratio, get_ao_compression_ratio('rle_type_1_delta');

Select * from rle_type_1_delta order by a1;

Select * from rle_type_1_delta where a1>2000 order by a1 ;

Select sum(a1) from rle_type_1_delta;
