...
--
CREATE TABLE sync2_ao_alter_part_add_default_part1 (id int, name text, rank int, year date, gender
...
--
insert into sync2_ao_alter_part_add_default_part1 values (generate_series(1,100),'ann',generate_series(1,100),'2001-01-01','F');
--
-- SYNC2 AO Part Table 2
--
CREATE TABLE sync2_ao_alter_part_add_default_part2 (id int, name text, rank int, year date, gender
char(1))  with ( appendonly='true') DISTRIBUTED BY (id, gender, year)
partition by list (gender)
subpartition by range (year)
subpartition template (
...
-- Insert few records into the table
--
insert into sync2_ao_alter_part_add_default_part2 values (generate_series(1,100),'ann',generate_series(1,100),'2001-01-01','F');
--
--
