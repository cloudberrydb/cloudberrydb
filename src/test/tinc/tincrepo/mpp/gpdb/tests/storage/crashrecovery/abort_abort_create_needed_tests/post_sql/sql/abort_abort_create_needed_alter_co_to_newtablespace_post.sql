...
INSERT INTO co_table_for_alter VALUES ('sync1_ao1',generate_series(1,10),'a',11,true,'111', repeat('text_',10), '{1,2,3,4,5}', 'Hello .. how are you 1
...
drop tablespace abort_create_needed_co_ts1;
drop tablespace abort_create_needed_co_ts2;
