...
class UAOCSFunctionsTestCase(SQLIsolationTestCase):
    """ 
    @tags ORCA
    """

    '''
    Test for support user-defined functions on updatable AOCS tables.
    ...
    @classmethod
    def setUpClass(cls):
        super(UAOCSFunctionsTestCase, cls).setUpClass()
        create_uao_udf()
