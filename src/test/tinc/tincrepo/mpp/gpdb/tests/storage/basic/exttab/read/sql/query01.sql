...
location ('file://@hostname@@gpfdist_datadir@/nation.tbl' )
...
location ('file://@hostname@@gpfdist_datadir@/region.tbl' )
FORMAT 'text' (delimiter '|');
...
location ('file://@hostname@@gpfdist_datadir@/part.tbl' )
FORMAT 'text' (delimiter '|');
...
location ('file://@hostname@@gpfdist_datadir@/supplier.tbl' )
FORMAT 'text' (delimiter '|');
...
location ('file://@hostname@@gpfdist_datadir@/partsupp.tbl' )
FORMAT 'text' (delimiter '|');
...
location ('file://@hostname@@gpfdist_datadir@/customer.tbl' )
FORMAT 'text' (delimiter '|');
...
location ('file://@hostname@@gpfdist_datadir@/orders.tbl' )
FORMAT 'text' (delimiter '|');
