...
-- start_ignore
Drop table if exists delta_neg_2_byte;
-- end_ignore

Create table delta_neg_2_byte(
    i int, 
    a1 integer, 
    a2 bigint, 
    a3 date, 
...
Insert into delta_neg_2_byte values 
...
Select 'compression_ratio' as compr_ratio, get_ao_compression_ratio('delta_neg_2_byte');

Select * from delta_neg_2_byte order by a1;
