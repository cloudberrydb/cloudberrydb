...
-- AO table
create table ao_table ( a int, b text) with (appendonly=true) distributed by (a);
...
-- CO table
create table co_table ( a int, b text) with (appendonly=true,orientation=column) distributed by (a);
...
CREATE WRITABLE EXTERNAL TABLE tbl_wet_insert (text_col text, bigint_col bigint, char_vary_col character varying(30)) LOCATION ('gpfdist://@hostname@:@gp_port@/output/wet_insert.tbl' ) FORMAT 'TEXT'  (DELIMITER '|' ) ;
...
CREATE EXTERNAL TABLE ret_region ( like region_1) LOCATION ('gpfdist://@hostname@:@gp_port@/output/wet_region.tbl') FORMAT 'TEXT' (DELIMITER AS '|');
...
CREATE WRITABLE EXTERNAL TABLE tbl_wet_syntax1 ( like test_dp1) LOCATION ('gpfdist://@hostname@:@gp_port@/output/wet_syntax1.tbl') FORMAT 'TEXT' (DELIMITER '|' ) DISTRIBUTED BY (a);

insert into tbl_wet_syntax1 values ( generate_series(1,10), 'test_dp_1');

CREATE WRITABLE EXTERNAL TABLE tbl_wet_syntax2 ( like test_dp1) LOCATION ('gpfdist://@hostname@:@gp_port@/output/wet_syntax2.tbl') FORMAT 'TEXT' (DELIMITER '|' ) DISTRIBUTED BY (b);

insert into tbl_wet_syntax2 values ( generate_series(1,10), 'test_dp_1');


CREATE WRITABLE EXTERNAL TABLE tbl_wet_syntax3 ( like test_dp1) LOCATION ('gpfdist://@hostname@:@gp_port@/output/wet_syntax3.tbl') FORMAT 'TEXT' (DELIMITER '|' ) DISTRIBUTED randomly;
...
CREATE WRITABLE EXTERNAL TABLE tbl_wet_syntax4 ( like test_dp2) LOCATION ('gpfdist://@hostname@:@gp_port@/output/wet_syntax4.tbl') FORMAT 'TEXT' (DELIMITER '|' ) DISTRIBUTED BY (a);

insert into tbl_wet_syntax4 values ( generate_series(1,10), 'test_dp_1');

CREATE WRITABLE EXTERNAL TABLE tbl_wet_syntax5 ( like test_dp2) LOCATION ('gpfdist://@hostname@:@gp_port@/output/wet_syntax5.tbl') FORMAT 'TEXT' (DELIMITER '|' ) DISTRIBUTED BY (b);

insert into tbl_wet_syntax5 values ( generate_series(1,10), 'test_dp_1');


CREATE WRITABLE EXTERNAL TABLE tbl_wet_syntax6 ( like test_dp2) LOCATION ('gpfdist://@hostname@:@gp_port@/output/wet_syntax6.tbl') FORMAT 'TEXT' (DELIMITER '|' ) DISTRIBUTED randomly;
...
CREATE WRITABLE EXTERNAL TABLE tbl_wet_syntax7 ( like test_dp3) LOCATION ('gpfdist://@hostname@:@gp_port@/output/wet_syntax7.tbl') FORMAT 'TEXT' (DELIMITER '|' ) DISTRIBUTED BY (a);

insert into tbl_wet_syntax7 values ( generate_series(1,10), 'test_dp_1');

CREATE WRITABLE EXTERNAL TABLE tbl_wet_syntax8 ( like test_dp3) LOCATION ('gpfdist://@hostname@:@gp_port@/output/wet_syntax8.tbl') FORMAT 'TEXT' (DELIMITER '|' ) DISTRIBUTED BY (b);

insert into tbl_wet_syntax8 values ( generate_series(1,10), 'test_dp_1');


CREATE WRITABLE EXTERNAL TABLE tbl_wet_syntax9 ( like test_dp3) LOCATION ('gpfdist://@hostname@:@gp_port@/output/wet_syntax9.tbl') FORMAT 'TEXT' (DELIMITER '|' ) DISTRIBUTED randomly;

insert into tbl_wet_syntax9 values ( generate_series(1,10), 'test_dp_1');


CREATE WRITABLE EXTERNAL TABLE tbl_wet_syntax10 ( a int, b text) LOCATION ('gpfdist://@hostname@:@gp_port@/output/wet_syntax10.tbl') FORMAT 'TEXT' DISTRIBUTED RANDOMLY;
 insert into tbl_wet_syntax10 values ( generate_series(1,10), 'test_dp_1');

CREATE WRITABLE EXTERNAL TABLE tbl_wet_syntax11 ( a int, b text) LOCATION ('gpfdist://@hostname@:@gp_port@/output/wet_syntax11.tbl') FORMAT 'TEXT' (DELIMITER '|' ) DISTRIBUTED BY (a);
 insert into tbl_wet_syntax11 values ( generate_series(1,10), 'test_dp_1');

CREATE WRITABLE EXTERNAL TABLE tbl_wet_syntax12 ( a int, b text) LOCATION ('gpfdist://@hostname@:@gp_port@/output/wet_syntax12.tbl') FORMAT 'TEXT' (DELIMITER '|' ) DISTRIBUTED BY (b);
