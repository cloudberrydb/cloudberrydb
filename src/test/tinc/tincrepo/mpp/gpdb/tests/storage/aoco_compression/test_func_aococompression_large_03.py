...
def test_data_provider():
    data = {
            'test_01_1_ao_create_with_row_part_large':['ao_create_with_row_part_large_2G_zlib'],
            'test_02_1_co_create_column_reference_column_part_large':['co_create_column_reference_column_part_large_2G_zlib'],
            'test_02_2_co_create_column_reference_column_part_large':['co_create_column_reference_column_part_large_2G_quick_rle'],
            'test_02_3_co_create_column_reference_column_part_large':['co_create_column_reference_column_part_large_2G_zlib_2'],
           }
    return data
