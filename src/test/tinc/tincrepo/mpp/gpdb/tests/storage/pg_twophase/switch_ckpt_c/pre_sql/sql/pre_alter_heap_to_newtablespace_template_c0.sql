...
-- end_ignore
create tablespace pg2_heap_ts1_c0 filespace filespace_test_a;
create tablespace pg2_heap_ts2_c0 filespace filespace_test_a;
CREATE TABLE pg2_heap_table_for_alter_c0 (phase text,a int,col001 char DEFAULT 'z',col002 numeric,col003 boolean DEFAULT false,col004 bit(3) DEFAULT '111',
...
col032 date, col034 lseg,col035 point,col036 polygon,col037 real,col039 time, col040 timestamp) tablespace pg2_heap_ts1_c0;
