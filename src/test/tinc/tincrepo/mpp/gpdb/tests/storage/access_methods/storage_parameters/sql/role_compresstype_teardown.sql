...
Alter role dsp_role5 set gp_default_storage_options TO DEFAULT;

select rolname, rolconfig from pg_roles where rolname in ('dsp_role1', 'dsp_role2', 'dsp_role3', 'dsp_role4', 'dsp_role5') order by rolname;
