...
CREATE TABLE uao_tab_blocksize_del_8k  with (appendonly=true, orientation=column , BLOCKSIZE=8192 )  AS (
...
CREATE TABLE uao_tab_blocksize_del_2048k  with (appendonly=true, orientation=column , BLOCKSIZE=2097152 )  AS (
SELECT GENERATE_SERIES::numeric sno
     , (random() * 10000000)::numeric + 10000000 val1
     , timeofday()::varchar(50) val2
     , (random() * 5000)::bigint + 10000000 val3
...
CREATE TABLE uao_tab_blocksize_del_default with (appendonly=true, orientation=column)  AS (
SELECT GENERATE_SERIES::numeric sno
     , (random() * 10000000)::numeric + 10000000 val1
     , timeofday()::varchar(50) val2
     , (random() * 5000)::bigint + 10000000 val3
