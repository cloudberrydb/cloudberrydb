CREATE TABLE abort_create_needed_co_jit_table( phase text,a int,col001 char DEFAULT 'z',col002 numeric,col003 boolean DEFAULT false,col004 bit(3) DEFAULT '111',
...
col032 date, col034 lseg,col035 point,col036 polygon,col037 real,col039 time, col040 timestamp ) with (appendonly=true,orientation=column) tablespace abort_create_needed_co_ts ;
\d abort_create_needed_co_jit_table
INSERT INTO abort_create_needed_co_jit_table VALUES ('sync1_co1',generate_series(1,10),'a',11,true,'111', repeat('text_',10), '{1,2,3,4,5}', 'Hello .. how are you 1
...
DROP table abort_create_needed_co_jit_table;
drop tablespace abort_create_needed_co_ts;
