...
--
create table sync2_co_alter_part_add_part1 (a char, b int, d char,e text) with ( appendonly='true', orientation='column')
...
--
 insert into sync2_co_alter_part_add_part1 values ('a',generate_series(1,5),'b','test_1');
--
-- SYNC2 CO Part Table 2
--
create table sync2_co_alter_part_add_part2 (a char, b int, d char,e text) with ( appendonly='true', orientation='column')
partition by range (b)
subpartition by list (d)
subpartition template (
 subpartition sp1 values ('a'),
...
-- Insert few records into the table
--
 insert into sync2_co_alter_part_add_part2 values ('a',generate_series(1,5),'b','test_1');
--
--
...
--
alter table sync1_co_alter_part_add_part7 set subpartition template ();
--
-- Add Partition
--
...
-- Set subpartition Template
--
alter table ck_sync1_co_alter_part_add_part6 set subpartition template ();
--
-- Add Partition
--
...
-- Set subpartition Template
--
alter table  ct_co_alter_part_add_part4 set subpartition template ();
--
-- Add Partition
--
...
-- Set subpartition Template
--
alter table resync_co_alter_part_add_part2 set subpartition template ();
--
-- Add Partition
--
...
-- Set subpartition Template
--
alter table sync2_co_alter_part_add_part1 set subpartition template ();
--
-- Add Partition
--
