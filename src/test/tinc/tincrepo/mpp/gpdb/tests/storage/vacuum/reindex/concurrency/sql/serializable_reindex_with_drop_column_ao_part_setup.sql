...
create index idxa_reindex_serialize_tab_ao_part on reindex_serialize_tab_ao_part(id);
create index idxb_reindex_serialize_tab_ao_part on reindex_serialize_tab_ao_part(owner);
create index idxc_reindex_serialize_tab_ao_part on reindex_serialize_tab_ao_part USING GIST(property);
create index idxd_reindex_serialize_tab_ao_part on reindex_serialize_tab_ao_part USING GIST(poli);
create index idxe_reindex_serialize_tab_ao_part on reindex_serialize_tab_ao_part USING GIST(target);
