...
create readable external table boolean_heap(datatype_boolean varchar, x_boolean bigint, col1_boolean boolean, nullcol_boolean boolean) location ('gpfdist://%localhost%:%gpfdistPort%/boolean.txt')format 'TEXT';
