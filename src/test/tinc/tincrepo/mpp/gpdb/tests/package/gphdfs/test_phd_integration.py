...
class PHDIntegrationTest(SQLTestCase):
    """
    Hadoop Integration tests : Greenplum DB with Pivotal HD
    ...
    def setUpClass(cls):
        ...
        # hadoop installation directory; where PHD tar ball is untared
        ...
        super(PHDIntegrationTest, cls).setUpClass()
    ...
    def tearDown(self):
        ...
        super(PHDIntegrationTest, self).tearDown()
