...
insert into uao_part01_1 values(generate_series(1,5), generate_series(1,15), generate_series(1,7));

-- Partition only table
create table uao_part03_1( a int, b int, c int,d int  ) with(appendonly= true)
 partition by range(b) (default partition others, start(1) end(15) every(5));
 
insert into uao_part03_1 values(1, generate_series(1,20), 4, 5);
Update uao_part03_1 set c=10 where b>15;

-- Mixed partition table
create table uao_part06_1( a int, b int, c int,d int  ) with(appendonly= true)
...
insert into uao_part06_1 values(1, generate_series(1,19), 4, 5);
Update uao_part06_1 set c=7 where b=6;
