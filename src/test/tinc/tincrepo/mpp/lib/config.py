...
class GPDBConfig():
    ...
    def _fill(self):
        ...
        self.record = []
        config_sql = "select dbid, content, role, preferred_role, mode, status, hostname, address, port, datadir from gp_segment_configuration ORDER BY content, preferred_role;"
