-- @description cte_pg_size_pretty.sql
...
WITH v(a,b) AS (SELECT pg_size_pretty(b)), b FROM foo WHERE b > 10000) SELECT v1.a, v2.b FROM v AS v1, v AS v2 WHERE v1.a < v2.a;
