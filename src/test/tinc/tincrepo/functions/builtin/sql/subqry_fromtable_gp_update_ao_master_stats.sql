-- @description subqry_fromtable_gp_update_ao_master_stats.sql
...
SELECT * FROM bar, (SELECT gp_update_ao_master_stats('ao_tab2') from foo ORDER BY 1) r ORDER BY 1,2,3;
