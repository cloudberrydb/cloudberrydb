...
typedef bool (*ActivateLock_hook_type) (const LOCKTAG *locktag, LOCKMODE lockmode, bool sessionLock, bool dontWait);
extern PGDLLIMPORT ActivateLock_hook_type ActivateLock_hook;
