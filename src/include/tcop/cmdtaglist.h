...
PG_CMDTAG(CMDTAG_ALTER_DIRECTORY_TABLE, "ALTER DIRECTORY TABLE", true, false, false)
...
PG_CMDTAG(CMDTAG_ALTER_STORAGE_SERVER, "ALTER STORAGE SERVER", true, false, false)
PG_CMDTAG(CMDTAG_ALTER_STORAGE_USER_MAPPING, "ALTER STORAGE USER MAPPING", true, false, false)
...
PG_CMDTAG(CMDTAG_ALTER_TAG, "ALTER TAG", true, false, false)
PG_CMDTAG(CMDTAG_ALTER_TASK, "ALTER TASK", true, false, false)
...
PG_CMDTAG(CMDTAG_DTX_BEGIN_INTERNAL_SUBTRANSACTION, "Begin Internal Subtransaction", false, false, false)
...
PG_CMDTAG(CMDTAG_CREATE_STORAGE_SERVER, "CREATE STORAGE SERVER", true, false, false)
PG_CMDTAG(CMDTAG_CREATE_STORAGE_USER_MAPPING, "CREATE STORAGE USER MAPPING", true, false, false)
...
PG_CMDTAG(CMDTAG_CREATE_TAG, "CREATE TAG", true, false, false)
...
PG_CMDTAG(CMDTAG_DTX_ABORT_NO_PREPARED,               "Distributed Abort (No Prepared)", false, false, false)
PG_CMDTAG(CMDTAG_DTX_ABORT_SOME_PREPARED,             "Distributed Abort (Some Prepared)", false, false, false)
PG_CMDTAG(CMDTAG_DTX_ABORT_PREPARED,                  "Distributed Abort Prepared", false, false, false)
PG_CMDTAG(CMDTAG_DTX_COMMIT_ONEPHASE,                 "Distributed Commit (one-phase)", false, false, false)
PG_CMDTAG(CMDTAG_DTX_COMMIT_PREPARED,                 "Distributed Commit Prepared", false, false, false)
PG_CMDTAG(CMDTAG_DTX_PREPARE,                         "Distributed Prepare", false, false, false)
...
PG_CMDTAG(CMDTAG_DROP_STORAGE_SERVER, "DROP STORAGE SERVER", true, false, false)
PG_CMDTAG(CMDTAG_DROP_STORAGE_USER_MAPPING, "DROP STORAGE USER MAPPING", true, false, false)
...
PG_CMDTAG(CMDTAG_DROP_TAG, "DROP TAG", true, false, false)
PG_CMDTAG(CMDTAG_DROP_TASK, "DROP TASK", true, false, false)
...
PG_CMDTAG(CMDTAG_DTX_RETRY_ABORT_PREPARED,            "Retry Distributed Abort Prepared", false, false, false)
PG_CMDTAG(CMDTAG_DTX_RETRY_COMMIT_PREPARED,           "Retry Distributed Commit Prepared", false, false, false)
...
PG_CMDTAG(CMDTAG_DTX_ROLLBACK_CURRENT_SUBTRANSACTION, "Rollback Current Subtransaction", false, false, false)
...
PG_CMDTAG(CMDTAG_FTS_MSG_SYNCREP_OFF, "SYNCREP_OFF", false, false, false)
