 ...
 *
 * NOTE:Bitmap AM building code expects to see the TIDs in ascending
 * order, while the AO code will return 0x8000 before 1-0xFFFF.So
 * if the ItemPointer is generated by AO/AOCS tables, the
 * value of ip_posid field may be 0x8000, we must process this
 * case. For more details please see the note of AOTupleId struct.
 */
