...
DATA(insert OID = 6024 ( float4_decum  PGNSP PGUID 12 1 0 0 0 f f f f t f i 2 0 1022 "1022 700" _null_ _null_ _null_ _null_ float4_decum _null_ _null_ _null_ n a ));
DESCR("aggregate inverse transition function");

/* float4_avg_accum(bytea, float4) => bytea */
DATA(insert OID = 4106 ( float4_avg_accum  PGNSP PGUID 12 1 0 0 0 f f f f t f i 2 0 17 "17 700" _null_ _null_ _null_ _null_ float4_avg_accum _null_ _null_ _null_ n a ));
DESCR("aggregate transition function");

/* float4_avg_decum(bytea, float4) => bytea */
DATA(insert OID = 4107 ( float4_avg_decum  PGNSP PGUID 12 1 0 0 0 f f f f t f i 2 0 17 "17 700" _null_ _null_ _null_ _null_ float4_avg_decum _null_ _null_ _null_ n a ));
DESCR("aggregate inverse transition function");

/* float8_decum(_float8, float8) => _float8 */
DATA(insert OID = 6025 ( float8_decum  PGNSP PGUID 12 1 0 0 0 f f f f t f i 2 0 1022 "1022 701" _null_ _null_ _null_ _null_ float8_decum _null_ _null_ _null_ n a ));
DESCR("aggregate inverse transition function");

/* float8_avg_accum(bytea, float8) => bytea */
DATA(insert OID = 4108 ( float8_avg_accum  PGNSP PGUID 12 1 0 0 0 f f f f t f i 2 0 17 "17 701" _null_ _null_ _null_ _null_ float8_avg_accum _null_ _null_ _null_ n a ));
DESCR("aggregate transition function");

/* float8_avg_decum(bytea, float8) => bytea */
DATA(insert OID = 4109 ( float8_avg_decum  PGNSP PGUID 12 1 0 0 0 f f f f t f i 2 0 17 "17 701" _null_ _null_ _null_ _null_ float8_avg_decum _null_ _null_ _null_ n a ));
DESCR("aggregate inverse transition function");

/* btgpxlogloccmp(gpxlogloc, gpxlogloc) => int4 */
DATA(insert OID = 7081 ( btgpxlogloccmp  PGNSP PGUID 12 1 0 0 0 f f f f t f i 2 0 23 "3310 3310" _null_ _null_ _null_ _null_ btgpxlogloccmp _null_ _null_ _null_ n a ));
...
/* int8dec(int8) => int8 */
DATA(insert OID = 3546 ( int8dec  PGNSP PGUID 12 1 0 0 0 f f f f t f i 1 0 20 "20" _null_ _null_ _null_ _null_ int8dec _null_ _null_ _null_ n a ));
DESCR("decrement");
...
DATA(insert OID = 7309 ( numeric_decum  PGNSP PGUID 12 1 0 0 0 f f f f t f i 2 0 1231 "1231 1700" _null_ _null_ _null_ _null_ numeric_decum _null_ _null_ _null_ n a ));
DESCR("aggregate inverse transition function");

/* numeric_avg_decum(bytea, "numeric") => bytea */
DATA(insert OID = 4103 ( numeric_avg_decum  PGNSP PGUID 12 1 0 0 0 f f f f t f i 2 0 17 "17 1700" _null_ _null_ _null_ _null_ numeric_avg_decum _null_ _null_ _null_ n a ));
DESCR("aggregate inverse transition function");

/* int2_decum(_numeric, int2) => _numeric */
DATA(insert OID = 7306 ( int2_decum  PGNSP PGUID 12 1 0 0 0 f f f f t f i 2 0 1231 "1231 21" _null_ _null_ _null_ _null_ int2_decum _null_ _null_ _null_ n a ));
DESCR("aggregate inverse transition function");

/* int4_decum(_numeric, int4) => _numeric */
DATA(insert OID = 7307 ( int4_decum  PGNSP PGUID 12 1 0 0 0 f f f f t f i 2 0 1231 "1231 23" _null_ _null_ _null_ _null_ int4_decum _null_ _null_ _null_ n a ));
DESCR("aggregate inverse transition function");

/* int8_decum(_numeric, int8) => _numeric */
DATA(insert OID = 7308 ( int8_decum  PGNSP PGUID 12 1 0 0 0 f f f f t f i 2 0 1231 "1231 20" _null_ _null_ _null_ _null_ int8_decum _null_ _null_ _null_ n a ));
DESCR("aggregate inverse transition function");

/* int2_invsum(int8, int2) => int8 */
DATA(insert OID = 7008 ( int2_invsum  PGNSP PGUID 12 1 0 0 0 f f f f f f i 2 0 20 "20 21" _null_ _null_ _null_ _null_ int2_invsum _null_ _null_ _null_ n a ));
DESCR("SUM(int2) inverse transition function");

/* int4_invsum(int8, int4) => int8 */
DATA(insert OID = 7009 ( int4_invsum  PGNSP PGUID 12 1 0 0 0 f f f f f f i 2 0 20 "20 23" _null_ _null_ _null_ _null_ int4_invsum _null_ _null_ _null_ n a ));
DESCR("SUM(int4) inverse transition function");

/* int8_invsum("numeric", int8) => "numeric" */
DATA(insert OID = 7010 ( int8_invsum  PGNSP PGUID 12 1 0 0 0 f f f f f f i 2 0 1700 "1700 20" _null_ _null_ _null_ _null_ int8_invsum _null_ _null_ _null_ n a ));
DESCR("SUM(int8) inverse transition function");

/* interval_decum(_interval, "interval") => _interval */
DATA(insert OID = 6038 ( interval_decum  PGNSP PGUID 12 1 0 0 0 f f f f t f i 2 0 1187 "1187 1186" _null_ _null_ _null_ _null_ interval_decum _null_ _null_ _null_ n a ));
DESCR("aggregate inverse transition function");

/* int2_avg_decum(bytea, int2) => bytea */
DATA(insert OID = 6019 ( int2_avg_decum  PGNSP PGUID 12 1 0 0 0 f f f f t f i 2 0 17 "17 21" _null_ _null_ _null_ _null_ int2_avg_decum _null_ _null_ _null_ n a ));
DESCR("AVG(int2) transition function");

/* int4_avg_decum(bytea, int4) => bytea */
DATA(insert OID = 6020 ( int4_avg_decum  PGNSP PGUID 12 1 0 0 0 f f f f t f i 2 0 17 "17 23" _null_ _null_ _null_ _null_ int4_avg_decum _null_ _null_ _null_ n a ));
DESCR("AVG(int4) transition function");

/* int8_avg_decum(bytea, int8) => bytea */
DATA(insert OID = 4101 ( int8_avg_decum  PGNSP PGUID 12 1 0 0 0 f f f f t f i 2 0 17 "17 20" _null_ _null_ _null_ _null_ int8_avg_decum _null_ _null_ _null_ n a ));
...
DATA(insert OID = 3332 ( max  PGNSP PGUID 12 1 0 0 0 t f f f f f i 1 0 3310 "3310" _null_ _null_ _null_ _null_ aggregate_dummy _null_ _null_ _null_ n a ));
DESCR("maximum value of all gpxlogloc input values");

/* min(gpxlogloc) => gpxlogloc */
DATA(insert OID = 3333 ( min  PGNSP PGUID 12 1 0 0 0 t f f f f f i 1 0 3310 "3310" _null_ _null_ _null_ _null_ aggregate_dummy _null_ _null_ _null_ n a ));
...
DATA(insert OID = 3212 ( int2_matrix_accum  PGNSP PGUID 12 1 0 0 0 f f f f f f i 2 0 1016 "1016 1005" _null_ _null_ _null_ _null_ matrix_add _null_ _null_ _null_ n a ));
DESCR("perform matrix addition on two conformable matrices");

/* int4_matrix_accum(_int8, _int4) => _int8 */
DATA(insert OID = 3213 ( int4_matrix_accum  PGNSP PGUID 12 1 0 0 0 f f f f f f i 2 0 1016 "1016 1007" _null_ _null_ _null_ _null_ matrix_add _null_ _null_ _null_ n a ));
DESCR("perform matrix addition on two conformable matrices");

/* int8_matrix_accum(_int8, _int8) => _int8 */
DATA(insert OID = 3214 ( int8_matrix_accum  PGNSP PGUID 12 1 0 0 0 f f f f t f i 2 0 1016 "1016 1016" _null_ _null_ _null_ _null_ matrix_add _null_ _null_ _null_ n a ));
DESCR("perform matrix addition on two conformable matrices");

/* float8_matrix_accum(_float8, _float8) => _float8 */
DATA(insert OID = 3215 ( float8_matrix_accum  PGNSP PGUID 12 1 0 0 0 f f f f t f i 2 0 1022 "1022 1022" _null_ _null_ _null_ _null_ matrix_add _null_ _null_ _null_ n a ));
DESCR("perform matrix addition on two conformable matrices");

/* sum(_int2) => _int8 */
DATA(insert OID = 3216 ( sum  PGNSP PGUID 12 1 0 0 0 t f f f f f i 1 0 1016 "1005" _null_ _null_ _null_ _null_ aggregate_dummy _null_ _null_ _null_ n a ));
DESCR("sum of matrixes");

/* sum(_int4) => _int8 */
DATA(insert OID = 3217 ( sum  PGNSP PGUID 12 1 0 0 0 t f f f f f i 1 0 1016 "1007" _null_ _null_ _null_ _null_ aggregate_dummy _null_ _null_ _null_ n a ));
DESCR("sum of matrixes");

/* sum(_int8) => _int8 */
DATA(insert OID = 3218 ( sum  PGNSP PGUID 12 1 0 0 0 t f f f f f i 1 0 1016 "1016" _null_ _null_ _null_ _null_ aggregate_dummy _null_ _null_ _null_ n a ));
DESCR("sum of matrixes");

/* sum(_float8) => _float8 */
DATA(insert OID = 3219 ( sum  PGNSP PGUID 12 1 0 0 0 t f f f f f i 1 0 1022 "1022" _null_ _null_ _null_ _null_ aggregate_dummy _null_ _null_ _null_ n a ));
DESCR("sum of matrixes");


/* 3220 - reserved for sum(numeric[])  */
/* int4_pivot_accum(_int4, _text, text, int4) => _int4 */
DATA(insert OID = 3225 ( int4_pivot_accum  PGNSP PGUID 12 1 0 0 0 f f f f f f i 4 0 1007 "1007 1009 25 23" _null_ _null_ _null_ _null_ int4_pivot_accum _null_ _null_ _null_ n a ));
DESCR("aggregate transition function");

/* pivot_sum(_text, text, int4) => _int4 */
DATA(insert OID = 3226 ( pivot_sum  PGNSP PGUID 12 1 0 0 0 t f f f f f i 3 0 1007 "1009 25 23" _null_ _null_ _null_ _null_ aggregate_dummy _null_ _null_ _null_ n a ));
DESCR("pivot sum aggregate");

/* int8_pivot_accum(_int8, _text, text, int8) => _int8 */
DATA(insert OID = 3227 ( int8_pivot_accum  PGNSP PGUID 12 1 0 0 0 f f f f f f i 4 0 1016 "1016 1009 25 20" _null_ _null_ _null_ _null_ int8_pivot_accum _null_ _null_ _null_ n a ));
DESCR("aggregate transition function");

/* pivot_sum(_text, text, int8) => _int8 */
DATA(insert OID = 3228 ( pivot_sum  PGNSP PGUID 12 1 0 0 0 t f f f f f i 3 0 1016 "1009 25 20" _null_ _null_ _null_ _null_ aggregate_dummy _null_ _null_ _null_ n a ));
DESCR("pivot sum aggregate");

/* float8_pivot_accum(_float8, _text, text, float8) => _float8 */
DATA(insert OID = 3229 ( float8_pivot_accum  PGNSP PGUID 12 1 0 0 0 f f f f f f i 4 0 1022 "1022 1009 25 701" _null_ _null_ _null_ _null_ float8_pivot_accum _null_ _null_ _null_ n a ));
DESCR("aggregate transition function");

/* pivot_sum(_text, text, float8) => _float8 */
DATA(insert OID = 3230 ( pivot_sum  PGNSP PGUID 12 1 0 0 0 t f f f f f i 3 0 1022 "1009 25 701" _null_ _null_ _null_ _null_ aggregate_dummy _null_ _null_ _null_ n a ));
DESCR("pivot sum aggregate");


/* 3241-324? reserved for unpivot, see pivot.c  */
/* gpaotidin(cstring) => gpaotid */
DATA(insert OID = 3302 ( gpaotidin  PGNSP PGUID 12 1 0 0 0 f f f f t f i 1 0 3300 "2275" _null_ _null_ _null_ _null_ gpaotidin _null_ _null_ _null_ n a ));
DESCR("I/O");

/* gpaotidout(gpaotid) => cstring */
DATA(insert OID = 3303 ( gpaotidout  PGNSP PGUID 12 1 0 0 0 f f f f t f i 1 0 2275 "3300" _null_ _null_ _null_ _null_ gpaotidout _null_ _null_ _null_ n a ));
DESCR("I/O");

/* gpaotidrecv(internal) => gpaotid */
DATA(insert OID = 3304 ( gpaotidrecv  PGNSP PGUID 12 1 0 0 0 f f f f t f i 1 0 3300 "2281" _null_ _null_ _null_ _null_ gpaotidrecv _null_ _null_ _null_ n a ));
DESCR("I/O");

/* gpaotidsend(gpaotid) => bytea */
DATA(insert OID = 3305 ( gpaotidsend  PGNSP PGUID 12 1 0 0 0 f f f f t f i 1 0 17 "3300" _null_ _null_ _null_ _null_ gpaotidsend _null_ _null_ _null_ n a ));
DESCR("I/O");

/* gpxloglocin(cstring) => gpxlogloc */
DATA(insert OID = 3312 ( gpxloglocin  PGNSP PGUID 12 1 0 0 0 f f f f t f i 1 0 3310 "2275" _null_ _null_ _null_ _null_ gpxloglocin _null_ _null_ _null_ n a ));
DESCR("I/O");

/* gpxloglocout(gpxlogloc) => cstring */
DATA(insert OID = 3313 ( gpxloglocout  PGNSP PGUID 12 1 0 0 0 f f f f t f i 1 0 2275 "3310" _null_ _null_ _null_ _null_ gpxloglocout _null_ _null_ _null_ n a ));
DESCR("I/O");

/* gpxloglocrecv(internal) => gpxlogloc */
DATA(insert OID = 3314 ( gpxloglocrecv  PGNSP PGUID 12 1 0 0 0 f f f f t f i 1 0 3310 "2281" _null_ _null_ _null_ _null_ gpxloglocrecv _null_ _null_ _null_ n a ));
DESCR("I/O");

/* gpxloglocsend(gpxlogloc) => bytea */
DATA(insert OID = 3315 ( gpxloglocsend  PGNSP PGUID 12 1 0 0 0 f f f f t f i 1 0 17 "3310" _null_ _null_ _null_ _null_ gpxloglocsend _null_ _null_ _null_ n a ));
DESCR("I/O");

/* gpxlogloclarger(gpxlogloc, gpxlogloc) => gpxlogloc */
DATA(insert OID = 3318 ( gpxlogloclarger  PGNSP PGUID 12 1 0 0 0 f f f f t f i 2 0 3310 "3310 3310" _null_ _null_ _null_ _null_ gpxlogloclarger _null_ _null_ _null_ n a ));
DESCR("larger of two");

/* gpxloglocsmaller(gpxlogloc, gpxlogloc) => gpxlogloc */
DATA(insert OID = 3319 ( gpxloglocsmaller  PGNSP PGUID 12 1 0 0 0 f f f f t f i 2 0 3310 "3310 3310" _null_ _null_ _null_ _null_ gpxloglocsmaller _null_ _null_ _null_ n a ));
DESCR("smaller of two");

/* gpxlogloceq(gpxlogloc, gpxlogloc) => bool */
DATA(insert OID = 3331 ( gpxlogloceq  PGNSP PGUID 12 1 0 0 0 f f f f t f i 2 0 16 "3310 3310" _null_ _null_ _null_ _null_ gpxlogloceq _null_ _null_ _null_ n a ));

/* gpxloglocne(gpxlogloc, gpxlogloc) => bool */
DATA(insert OID = 3320 ( gpxloglocne  PGNSP PGUID 12 1 0 0 0 f f f f t f i 2 0 16 "3310 3310" _null_ _null_ _null_ _null_ gpxloglocne _null_ _null_ _null_ n a ));

/* gpxlogloclt(gpxlogloc, gpxlogloc) => bool */
DATA(insert OID = 3321 ( gpxlogloclt  PGNSP PGUID 12 1 0 0 0 f f f f t f i 2 0 16 "3310 3310" _null_ _null_ _null_ _null_ gpxlogloclt _null_ _null_ _null_ n a ));

/* gpxloglocle(gpxlogloc, gpxlogloc) => bool */
DATA(insert OID = 3322 ( gpxloglocle  PGNSP PGUID 12 1 0 0 0 f f f f t f i 2 0 16 "3310 3310" _null_ _null_ _null_ _null_ gpxloglocle _null_ _null_ _null_ n a ));
...
DATA(insert OID = 6008 ( numeric_amalg  PGNSP PGUID 12 1 0 0 0 f f f f t f i 2 0 1231 "1231 1231" _null_ _null_ _null_ _null_ numeric_amalg _null_ _null_ _null_ n a ));
DESCR("aggregate preliminary function");

/* numeric_avg_amalg(bytea, bytea) => bytea */
DATA(insert OID = 4104 ( numeric_avg_amalg  PGNSP PGUID 12 1 0 0 0 f f f f t f i 2 0 17 "17 17" _null_ _null_ _null_ _null_ numeric_avg_amalg _null_ _null_ _null_ n a ));
DESCR("aggregate preliminary function");

/* int8_avg_amalg(bytea, bytea) => bytea */
DATA(insert OID = 6009 ( int8_avg_amalg  PGNSP PGUID 12 1 0 0 0 f f f f t f i 2 0 17 "17 17" _null_ _null_ _null_ _null_ int8_avg_amalg _null_ _null_ _null_ n a ));
DESCR("aggregate preliminary function");

/* float8_amalg(_float8, _float8) => _float8 */
DATA(insert OID = 6010 ( float8_amalg  PGNSP PGUID 12 1 0 0 0 f f f f t f i 2 0 1022 "1022 1022" _null_ _null_ _null_ _null_ float8_amalg _null_ _null_ _null_ n a ));
DESCR("aggregate preliminary function");

/* float8_avg_amalg(bytea, bytea) => bytea */
DATA(insert OID = 4111 ( float8_avg_amalg  PGNSP PGUID 12 1 0 0 0 f f f f t f i 2 0 17 "17 17" _null_ _null_ _null_ _null_ float8_avg_amalg _null_ _null_ _null_ n a ));
DESCR("aggregate preliminary function");
...
DATA(insert OID = 6015 ( numeric_demalg  PGNSP PGUID 12 1 0 0 0 f f f f t f i 2 0 1231 "1231 1231" _null_ _null_ _null_ _null_ numeric_demalg _null_ _null_ _null_ n a ));
DESCR("aggregate inverse preliminary function");

/* numeric_avg_demalg(bytea, bytea) => bytea */
DATA(insert OID = 4105 ( numeric_avg_demalg  PGNSP PGUID 12 1 0 0 0 f f f f t f i 2 0 17 "17 17" _null_ _null_ _null_ _null_ numeric_avg_demalg _null_ _null_ _null_ n a ));
DESCR("aggregate inverse preliminary function");

/* int8_avg_demalg(bytea, bytea) => bytea */
DATA(insert OID = 6016 ( int8_avg_demalg  PGNSP PGUID 12 1 0 0 0 f f f f t f i 2 0 17 "17 17" _null_ _null_ _null_ _null_ int8_avg_demalg _null_ _null_ _null_ n a ));
DESCR("aggregate preliminary function");

/* float8_demalg(_float8, _float8) => _float8 */
DATA(insert OID = 6017 ( float8_demalg  PGNSP PGUID 12 1 0 0 0 f f f f t f i 2 0 1022 "1022 1022" _null_ _null_ _null_ _null_ float8_demalg _null_ _null_ _null_ n a ));
DESCR("aggregate inverse preliminary function");

/* float8_avg_demalg(bytea, bytea) => bytea */
DATA(insert OID = 4110 ( float8_avg_demalg  PGNSP PGUID 12 1 0 0 0 f f f f t f i 2 0 17 "17 17" _null_ _null_ _null_ _null_ float8_avg_demalg _null_ _null_ _null_ n a ));
DESCR("aggregate inverse preliminary function");

/* interval_demalg(_interval, _interval) => _interval */
DATA(insert OID = 6018 ( interval_demalg  PGNSP PGUID 12 1 0 0 0 f f f f t f i 2 0 1187 "1187 1187" _null_ _null_ _null_ _null_ interval_demalg _null_ _null_ _null_ n a ));
DESCR("aggregate preliminary function");

/* float8_regr_amalg(_float8, _float8) => _float8 */
DATA(insert OID = 6014 ( float8_regr_amalg  PGNSP PGUID 12 1 0 0 0 f f f f t f i 2 0 1022 "1022 1022" _null_ _null_ _null_ _null_ float8_regr_amalg _null_ _null_ _null_ n a ));
DESCR("aggregate preliminary function");
...
DATA(insert OID = 7169 ( get_ao_distribution  PGNSP PGUID 12 1 1000 0 0 f f f f f t v 1 0 2249 "26" "{26,23,20}" "{i,o,o}" "{reloid,segmentid,tupcount}" _null_ get_ao_distribution_oid _null_ _null_ _null_ r a ));
...
DATA(insert OID = 7170 ( get_ao_distribution  PGNSP PGUID 12 1 1000 0 0 f f f f f t v 1 0 2249 "25" "{25,23,20}" "{i,o,o}" "{relname,segmentid,tupcount}" _null_ get_ao_distribution_name _null_ _null_ _null_ r a ));
DESCR("show append only table tuple distribution across segment databases");

/* get_ao_compression_ratio(oid) => float8 */
DATA(insert OID = 7171 ( get_ao_compression_ratio  PGNSP PGUID 12 1 0 0 0 f f f f t f v 1 0 701 "26" _null_ _null_ _null_ _null_ get_ao_compression_ratio_oid _null_ _null_ _null_ r a ));
DESCR("show append only table compression ratio");

/* get_ao_compression_ratio(text) => float8 */
DATA(insert OID = 7172 ( get_ao_compression_ratio  PGNSP PGUID 12 1 0 0 0 f f f f t f v 1 0 701 "25" _null_ _null_ _null_ _null_ get_ao_compression_ratio_name _null_ _null_ _null_ r a ));
DESCR("show append only table compression ratio");

/* gp_update_ao_master_stats(oid) => int8 */
DATA(insert OID = 7173 ( gp_update_ao_master_stats  PGNSP PGUID 12 1 0 0 0 f f f f f f v 1 0 20 "26" _null_ _null_ _null_ _null_ gp_update_ao_master_stats_oid _null_ _null_ _null_ m a ));
DESCR("append only tables utility function");

/* gp_update_ao_master_stats(text) => int8 */
DATA(insert OID = 7174 ( gp_update_ao_master_stats  PGNSP PGUID 12 1 0 0 0 f f f f f f v 1 0 20 "25" _null_ _null_ _null_ _null_ gp_update_ao_master_stats_name _null_ _null_ _null_ m a ));
DESCR("append only tables utility function");
...
DATA(insert OID = 5032 ( gp_statistics_estimate_reltuples_relpages_oid  PGNSP PGUID 12 1 0 0 0 f f f f t f v 1 0 1021 "26" _null_ _null_ _null_ _null_ gp_statistics_estimate_reltuples_relpages_oid _null_ _null_ _null_ n a ));
...
DATA(insert OID = 5076 ( gp_quicklz_constructor  PGNSP PGUID 12 1 0 0 0 f f f f f f v 3 0 2281 "2281 2281 16" _null_ _null_ _null_ _null_ quicklz_constructor _null_ _null_ _null_ n a ));
DESCR("quicklz constructor");

/* gp_quicklz_destructor(internal) => void */
DATA(insert OID = 5077 ( gp_quicklz_destructor  PGNSP PGUID 12 1 0 0 0 f f f f f f v 1 0 2278 "2281" _null_ _null_ _null_ _null_ quicklz_destructor _null_ _null_ _null_ n a ));
DESCR("quicklz destructor");

/* gp_quicklz_compress(internal, int4, internal, int4, internal, internal) => void */
DATA(insert OID = 5078 ( gp_quicklz_compress  PGNSP PGUID 12 1 0 0 0 f f f f f f i 6 0 2278 "2281 23 2281 23 2281 2281" _null_ _null_ _null_ _null_ quicklz_compress _null_ _null_ _null_ n a ));
DESCR("quicklz compressor");

/* gp_quicklz_decompress(internal, int4, internal, int4, internal, internal) => void */
DATA(insert OID = 5079 ( gp_quicklz_decompress  PGNSP PGUID 12 1 0 0 0 f f f f f f i 6 0 2278 "2281 23 2281 23 2281 2281" _null_ _null_ _null_ _null_ quicklz_decompress _null_ _null_ _null_ n a ));
DESCR("quicklz decompressor");

/* gp_quicklz_validator(internal) => void */
DATA(insert OID = 9925 ( gp_quicklz_validator  PGNSP PGUID 12 1 0 0 0 f f f f f f i 1 0 2278 "2281" _null_ _null_ _null_ _null_ quicklz_validator _null_ _null_ _null_ n a ));
...
DATA(insert OID = 3548 ( complex_out  PGNSP PGUID 12 1 0 0 0 f f f f t f i 1 0 2275 "7198" _null_ _null_ _null_ _null_ complex_out _null_ _null_ _null_ n a ));
DESCR("I/O");

/* complex_recv(internal) => complex */
DATA(insert OID = 3549 ( complex_recv  PGNSP PGUID 12 1 0 0 0 f f f f t f i 1 0 7198 "2281" _null_ _null_ _null_ _null_ complex_recv _null_ _null_ _null_ n a ));
DESCR("I/O");

/* complex_send(complex) => bytea */
DATA(insert OID = 3550 ( complex_send  PGNSP PGUID 12 1 0 0 0 f f f f t f i 1 0 17 "7198" _null_ _null_ _null_ _null_ complex_send _null_ _null_ _null_ n a ));
DESCR("I/O");

/* complex(float8, float8) => complex */
DATA(insert OID = 3551 ( complex  PGNSP PGUID 12 1 0 0 0 f f f f t f i 2 0 7198 "701 701" _null_ _null_ _null_ _null_ construct_complex _null_ _null_ _null_ n a ));
DESCR("constructs a complex number with given real part and imaginary part");

/* complex_trig(float8, float8) => complex */
DATA(insert OID = 3552 ( complex_trig  PGNSP PGUID 12 1 0 0 0 f f f f t f i 2 0 7198 "701 701" _null_ _null_ _null_ _null_ construct_complex_trig _null_ _null_ _null_ n a ));
DESCR("constructs a complex number with given magnitude and phase");

/* re(complex) => float8 */
DATA(insert OID = 3553 ( re  PGNSP PGUID 12 1 0 0 0 f f f f t f i 1 0 701 "7198" _null_ _null_ _null_ _null_ complex_re _null_ _null_ _null_ n a ));
DESCR("returns the real part of the argument");

/* im(complex) => float8 */
DATA(insert OID = 3554 ( im  PGNSP PGUID 12 1 0 0 0 f f f f t f i 1 0 701 "7198" _null_ _null_ _null_ _null_ complex_im _null_ _null_ _null_ n a ));
DESCR("returns the imaginary part of the argument");

/* radians(complex) => float8 */
DATA(insert OID = 3555 ( radians  PGNSP PGUID 12 1 0 0 0 f f f f t f i 1 0 701 "7198" _null_ _null_ _null_ _null_ complex_arg _null_ _null_ _null_ n a ));
DESCR("returns the phase of the argument");

/* complexabs(complex) => float8 */
DATA(insert OID = 3556 ( complexabs  PGNSP PGUID 12 1 0 0 0 f f f f t f i 1 0 701 "7198" _null_ _null_ _null_ _null_ complex_mag _null_ _null_ _null_ n a ));

/* abs(complex) => float8 */
DATA(insert OID = 3557 ( abs  PGNSP PGUID 12 1 0 0 0 f f f f t f i 1 0 701 "7198" _null_ _null_ _null_ _null_ complex_mag _null_ _null_ _null_ n a ));
DESCR("returns the magnitude of the argument");

/* conj(complex) => complex */
DATA(insert OID = 3558 ( conj  PGNSP PGUID 12 1 0 0 0 f f f f t f i 1 0 7198 "7198" _null_ _null_ _null_ _null_ complex_conj _null_ _null_ _null_ n a ));
DESCR("returns the conjunction of the argument");

/* hashcomplex(complex) => int4 */
DATA(insert OID = 3559 ( hashcomplex  PGNSP PGUID 12 1 0 0 0 f f f f t f i 1 0 23 "7198" _null_ _null_ _null_ _null_ complex_hash _null_ _null_ _null_ n a ));
DESCR("hash");

/* complex_eq(complex, complex) => bool */
DATA(insert OID = 3560 ( complex_eq  PGNSP PGUID 12 1 0 0 0 f f f f t f i 2 0 16 "7198 7198" _null_ _null_ _null_ _null_ complex_eq _null_ _null_ _null_ n a ));
DESCR("equal");

/* complex_ne(complex, complex) => bool */
DATA(insert OID = 3561 ( complex_ne  PGNSP PGUID 12 1 0 0 0 f f f f t f i 2 0 16 "7198 7198" _null_ _null_ _null_ _null_ complex_ne _null_ _null_ _null_ n a ));
DESCR("not equal");

/* complex_pl(complex, complex) => complex */
DATA(insert OID = 3562 ( complex_pl  PGNSP PGUID 12 1 0 0 0 f f f f t f i 2 0 7198 "7198 7198" _null_ _null_ _null_ _null_ complex_pl _null_ _null_ _null_ n a ));

/* complex_up(complex) => complex */
DATA(insert OID = 3563 ( complex_up  PGNSP PGUID 12 1 0 0 0 f f f f t f i 1 0 7198 "7198" _null_ _null_ _null_ _null_ complex_up _null_ _null_ _null_ n a ));

/* complex_mi(complex, complex) => complex */
DATA(insert OID = 3564 ( complex_mi  PGNSP PGUID 12 1 0 0 0 f f f f t f i 2 0 7198 "7198 7198" _null_ _null_ _null_ _null_ complex_mi _null_ _null_ _null_ n a ));

/* complex_um(complex) => complex */
DATA(insert OID = 3565 ( complex_um  PGNSP PGUID 12 1 0 0 0 f f f f t f i 1 0 7198 "7198" _null_ _null_ _null_ _null_ complex_um _null_ _null_ _null_ n a ));

/* complex_mul(complex, complex) => complex */
DATA(insert OID = 3566 ( complex_mul  PGNSP PGUID 12 1 0 0 0 f f f f t f i 2 0 7198 "7198 7198" _null_ _null_ _null_ _null_ complex_mul _null_ _null_ _null_ n a ));

/* complex_div(complex, complex) => complex */
DATA(insert OID = 3567 ( complex_div  PGNSP PGUID 12 1 0 0 0 f f f f t f i 2 0 7198 "7198 7198" _null_ _null_ _null_ _null_ complex_div _null_ _null_ _null_ n a ));

/* complex_power(complex, complex) => complex */
DATA(insert OID = 3568 ( complex_power  PGNSP PGUID 12 1 0 0 0 f f f f t f i 2 0 7198 "7198 7198" _null_ _null_ _null_ _null_ complex_pow _null_ _null_ _null_ n a ));

/* complex_sqrt(complex) => complex */
DATA(insert OID = 3569 ( complex_sqrt  PGNSP PGUID 12 1 0 0 0 f f f f t f i 1 0 7198 "7198" _null_ _null_ _null_ _null_ complex_sqrt _null_ _null_ _null_ n a ));

/* complex_cbrt(complex) => complex */
DATA(insert OID = 3570 ( complex_cbrt  PGNSP PGUID 12 1 0 0 0 f f f f t f i 1 0 7198 "7198" _null_ _null_ _null_ _null_ complex_cbrt _null_ _null_ _null_ n a ));
DESCR("cube root");

/* degrees(complex) => float8 */
DATA(insert OID = 3571 ( degrees  PGNSP PGUID 12 1 0 0 0 f f f f t f i 1 0 701 "7198" _null_ _null_ _null_ _null_ complex_degrees _null_ _null_ _null_ n a ));
DESCR("phase to degrees");

/* exp(complex) => complex */
DATA(insert OID = 3572 ( exp  PGNSP PGUID 12 1 0 0 0 f f f f t f i 1 0 7198 "7198" _null_ _null_ _null_ _null_ complex_exp _null_ _null_ _null_ n a ));
...
DATA(insert OID = 3595 ( complex_lte  PGNSP PGUID 12 1 0 0 0 f f f f t f i 2 0 16 "7198 7198" _null_ _null_ _null_ _null_ complex_lte _null_ _null_ _null_ n a ));
