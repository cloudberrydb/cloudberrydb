...
DATA(insert OID = 6096 ( array_agg_transfn  PGNSP PGUID 12 f f f f i 2 2281 f "2281 2283" _null_ _null_ _null_ array_agg_transfn - _null_ n ));
DESCR("array_agg transition function");

/* array_agg_finalfn(internal) => anyarray */ 
DATA(insert OID = 6097 ( array_agg_finalfn  PGNSP PGUID 12 f f f f i 1 2277 f "2281" _null_ _null_ _null_ array_agg_finalfn - _null_ n ));
DESCR("array_agg final function");

/* array_agg(anyelement) => anyarray */ 
DATA(insert OID = 6098 ( array_agg  PGNSP PGUID 12 t f f f i 1 2277 f "2283" _null_ _null_ _null_ aggregate_dummy - _null_ n ));
...
/* int8dec(int8) => int8 */ 
DATA(insert OID = 3546 ( int8dec  PGNSP PGUID 12 f f t f i 1 20 f "20" _null_ _null_ _null_ int8dec - _null_ n ));

/* interval_interval_div("interval", "interval") => float8 */ 
DATA(insert OID = 6115 ( interval_interval_div  PGNSP PGUID 12 f f t f i 2 701 f "1186 1186" _null_ _null_ _null_ interval_interval_div - _null_ n ));
DESCR("divide");

/* interval_interval_mod("interval", "interval") => "interval" */ 
DATA(insert OID = 6116 ( interval_interval_mod  PGNSP PGUID 12 f f t f i 2 1186 f "1186 1186" _null_ _null_ _null_ interval_interval_mod - _null_ n ));
DESCR("modulus");
...
DATA(insert OID = 5027 ( pg_get_partition_rule_def  PGNSP PGUID 12 f f t f s 1 25 f "26" _null_ _null_ _null_ pg_get_partition_rule_def - _null_ n ));

/* pg_get_partition_rule_def(oid, bool) => text */ 
DATA(insert OID = 5028 ( pg_get_partition_rule_def  PGNSP PGUID 12 f f t f s 2 25 f "26 16" _null_ _null_ _null_ pg_get_partition_rule_def_ext - _null_ n ));
...
DATA(insert OID = 2991 ( interval_bound  PGNSP PGUID 12 f f t f i 2 1700 f "1700 1700" _null_ _null_ _null_ numeric_interval_bound - _null_ n ));
DESCR("boundary of the interval containing the given value");

/* interval_bound(numeric, numeric, int4) => numeric */ 
DATA(insert OID = 2992 ( interval_bound  PGNSP PGUID 12 f f f f i 3 1700 f "1700 1700 23" _null_ _null_ _null_ numeric_interval_bound_shift - _null_ n ));
DESCR("boundary of the interval containing the given value");

/* interval_bound(numeric, numeric, int4, numeric) => numeric */ 
DATA(insert OID = 2993 ( interval_bound  PGNSP PGUID 12 f f f f i 4 1700 f "1700 1700 23 1700" _null_ _null_ _null_ numeric_interval_bound_shift_rbound - _null_ n ));
DESCR("boundary of the interval containing the given value");

/* interval_bound(timestamp, "interval") => timestamp */ 
DATA(insert OID = 2994 ( interval_bound  PGNSP PGUID 12 f f t f i 2 1114 f "1114 1186" _null_ _null_ _null_ timestamp_interval_bound - _null_ n ));
DESCR("boundary of the interval containing the given value");

/* interval_bound(timestamp, "interval", int4) => timestamp */ 
DATA(insert OID = 2995 ( interval_bound  PGNSP PGUID 12 f f f f i 3 1114 f "1114 1186 23" _null_ _null_ _null_ timestamp_interval_bound_shift - _null_ n ));
DESCR("boundary of the interval containing the given value");

/* interval_bound(timestamp, "interval", int4, timestamp) => timestamp */ 
DATA(insert OID = 2996 ( interval_bound  PGNSP PGUID 12 f f f f i 4 1114 f "1114 1186 23 1114" _null_ _null_ _null_ timestamp_interval_bound_shift_reg - _null_ n ));
DESCR("boundary of the interval containing the given value");

/* interval_bound(timestamptz, "interval") => timestamptz */ 
DATA(insert OID = 2997 ( interval_bound  PGNSP PGUID 12 f f t f i 2 1184 f "1184 1186" _null_ _null_ _null_ timestamptz_interval_bound - _null_ n ));
DESCR("boundary of the interval containing the given value");

/* interval_bound(timestamptz, "interval", int4) => timestamptz */ 
DATA(insert OID = 2998 ( interval_bound  PGNSP PGUID 12 f f f f i 3 1184 f "1184 1186 23" _null_ _null_ _null_ timestamptz_interval_bound_shift - _null_ n ));
DESCR("boundary of the interval containing the given value");

/* interval_bound(timestamptz, "interval", int4, timestamptz) => timestamptz */ 
DATA(insert OID = 2999 ( interval_bound  PGNSP PGUID 12 f f f f i 4 1184 f "1184 1186 23 1184" _null_ _null_ _null_ timestamptz_interval_bound_shift_reg - _null_ n ));
DESCR("boundary of the interval containing the given value");
...
DATA(insert OID = 6099 ( pg_partition_oid_transfn  PGNSP PGUID 12 f f f f i 3 2281 f "2281 26 2249" _null_ _null_ _null_ pg_partition_oid_transfn - _null_ n ));
DESCR("pg_partition_oid transition function");

/* pg_partition_oid_finalfn(internal) => _oid */ 
DATA(insert OID = 6100 ( pg_partition_oid_finalfn  PGNSP PGUID 12 f f f f i 1 1028 f "2281" _null_ _null_ _null_ pg_partition_oid_finalfn - _null_ n ));
DESCR("pg_partition_oid final function");

/* pg_partition_oid(oid, record) => _oid */ 
DATA(insert OID = 6112 ( pg_partition_oid  PGNSP PGUID 12 t f f f i 2 1028 f "26 2249" _null_ _null_ _null_ aggregate_dummy - _null_ n ));


#define PG_PARTITION_OID_OID 6112
/* pg_stat_get_backend_waiting_reason(int4) => text */ 
DATA(insert OID = 2972 ( pg_stat_get_backend_waiting_reason  PGNSP PGUID 12 f f t f s 1 25 f "23" _null_ _null_ _null_ pg_stat_get_backend_waiting_reason - _null_ n ));
...
DATA(insert OID = 6071 ( pg_stat_get_activity  PGNSP PGUID 12 f f f t v 1 2249 f "23" "{23,26,23,26,25,25,16,1184,1184,1184,869,23,23,25}" "{i,o,o,o,o,o,o,o,o,o,o,o,o,o}" "{pid,datid,procpid,usesysid,application_name,current_query,waiting,xact_start,query_start,backend_start,client_addr,client_port,sess_id,waiting_reason}" pg_stat_get_activity - _null_ n ));
...
DATA(insert OID = 3099 ( pg_stat_get_wal_senders  PGNSP PGUID 12 f f f t s 0 2249 f "" "{23,25,25,25,25,25,23,25}" "{o,o,o,o,o,o,o,o}" "{pid,state,sent_location,write_location,flush_location,replay_location,sync_priority,sync_state}" pg_stat_get_wal_senders - _null_ n ));
DESCR("statistics: information about currently active replication");

/* pg_terminate_backend(int4) => bool */ 
DATA(insert OID = 6118 ( pg_terminate_backend  PGNSP PGUID 12 f f t f v 1 16 f "23" _null_ _null_ _null_ pg_terminate_backend - _null_ n ));
...
DATA(insert OID = 6113 ( generate_series  PGNSP PGUID 12 f f t t v 3 1114 f "1114 1114 1186" _null_ _null_ _null_ generate_series_timestamp - _null_ n ));
DESCR("non-persistent series generator");

/* generate_series("timestamptz", "timestamptz", "interval") => SETOF "timestamptz" */ 
DATA(insert OID = 6114 ( generate_series  PGNSP PGUID 12 f f t t v 3 1184 f "1184 1184 1186" _null_ _null_ _null_ generate_series_timestamptz - _null_ n ));
DESCR("non-persistent series generator");
...
DATA(insert OID = 6435 ( gp_changetracking_log  PGNSP PGUID 12 f f f t v 1 2249 f "23" "{23,21,21,26,26,26,3310,23,27,20}" "{i,o,o,o,o,o,o,o,o,o}" "{filetype,segment_id,dbid,space,db,rel,xlogloc,blocknum,persistent_tid,persistent_sn}" gp_changetracking_log - _null_ n ));
...
DATA(insert OID = 9900 ( aocsvpinfo_decode  PGNSP PGUID 12 f f t f i 3 20 f "1562 23 23" _null_ _null_ _null_ aocsvpinfo_decode - _null_ n ));
...
DATA(insert OID = 5032 ( gp_statistics_estimate_reltuples_relpages_oid  PGNSP PGUID 12 f f t f v 1 1021 f "26" _null_ _null_ _null_ gp_statistics_estimate_reltuples_relpages_oid - _null_ n ));
DESCR("Return reltuples/relpages information for relation.");


/* Backoff related */
/* gp_adjust_priority(int4, int4, int4) => int4 */ 
DATA(insert OID = 5040 ( gp_adjust_priority  PGNSP PGUID 12 f f t f v 3 23 f "23 23 23" _null_ _null_ _null_ gp_adjust_priority_int - _null_ n ));
DESCR("change weight of all the backends for a given session id");

/* gp_adjust_priority(int4, int4, text) => int4 */ 
DATA(insert OID = 5041 ( gp_adjust_priority  PGNSP PGUID 12 f f t f v 3 23 f "23 23 25" _null_ _null_ _null_ gp_adjust_priority_value - _null_ n ));
DESCR("change weight of all the backends for a given session id");

/* gp_list_backend_priorities() => SETOF record */ 
DATA(insert OID = 5042 ( gp_list_backend_priorities  PGNSP PGUID 12 f f f t v 0 2249 f "" _null_ _null_ _null_ gp_list_backend_priorities - _null_ n ));
...
DATA(insert OID = 5046 ( gp_add_master_standby  PGNSP PGUID 12 f f f f v 3 21 f "25 25 1009" _null_ _null_ _null_ gp_add_master_standby - _null_ n ));
DESCR("Perform the catalog operations necessary for adding a new standby");

/* gp_add_master_standby(text, text, _text, int4) => int2 */ 
DATA(insert OID = 5038 ( gp_add_master_standby  PGNSP PGUID 12 f f f f v 4 21 f "25 25 1009 23" _null_ _null_ _null_ gp_add_master_standby_port - _null_ n ));
DESCR("Perform the catalog operations necessary for adding a new standby");
...
DATA(insert OID = 5075 ( gp_dbspecific_ptcat_verification  PGNSP PGUID 12 f f f f v 0 16 f "" _null_ _null_ _null_ gp_dbspecific_ptcat_verification - _null_ n ));
DESCR("perform database specific PersistentTables-Catalog verification");

/* gp_nondbspecific_ptcat_verification() => bool */ 
DATA(insert OID = 5080 ( gp_nondbspecific_ptcat_verification  PGNSP PGUID 12 f f f f v 0 16 f "" _null_ _null_ _null_ gp_nondbspecific_ptcat_verification - _null_ n ));
...
DATA(insert OID = 6072 ( linear_interpolate  PGNSP PGUID 12 f f t f i 5 20 f "2283 2283 20 2283 20" _null_ _null_ _null_ linterp_int64 - _null_ n ));
DESCR("linear interpolation: x, x0,y0, x1,y1");

/* linear_interpolate( anyelement, anyelement, int4, anyelement, int4) => int4 */ 
DATA(insert OID = 6073 ( linear_interpolate  PGNSP PGUID 12 f f t f i 5 23 f "2283 2283 23 2283 23" _null_ _null_ _null_ linterp_int32 - _null_ n ));
DESCR("linear interpolation: x, x0,y0, x1,y1");

/* linear_interpolate( anyelement, anyelement, int2, anyelement, int2) => int2 */ 
DATA(insert OID = 6074 ( linear_interpolate  PGNSP PGUID 12 f f t f i 5 21 f "2283 2283 21 2283 21" _null_ _null_ _null_ linterp_int16 - _null_ n ));
DESCR("linear interpolation: x, x0,y0, x1,y1");

/* linear_interpolate( anyelement, anyelement, float8, anyelement, float8) => float8 */ 
DATA(insert OID = 6075 ( linear_interpolate  PGNSP PGUID 12 f f t f i 5 701 f "2283 2283 701 2283 701" _null_ _null_ _null_ linterp_float8 - _null_ n ));
DESCR("linear interpolation: x, x0,y0, x1,y1");

/* linear_interpolate( anyelement, anyelement, float4, anyelement, float4) => float4 */ 
DATA(insert OID = 6076 ( linear_interpolate  PGNSP PGUID 12 f f t f i 5 700 f "2283 2283 700 2283 700" _null_ _null_ _null_ linterp_float4 - _null_ n ));
DESCR("linear interpolation: x, x0,y0, x1,y1");

/* linear_interpolate( anyelement, anyelement, date, anyelement, date) => date */ 
DATA(insert OID = 6077 ( linear_interpolate  PGNSP PGUID 12 f f t f i 5 1082 f "2283 2283 1082 2283 1082" _null_ _null_ _null_ linterp_DateADT - _null_ n ));
DESCR("linear interpolation: x, x0,y0, x1,y1");

/* linear_interpolate( anyelement, anyelement, time, anyelement, time) => time */ 
DATA(insert OID = 6078 ( linear_interpolate  PGNSP PGUID 12 f f t f i 5 1083 f "2283 2283 1083 2283 1083" _null_ _null_ _null_ linterp_TimeADT - _null_ n ));
DESCR("linear interpolation: x, x0,y0, x1,y1");

/* linear_interpolate( anyelement, anyelement, timestamp, anyelement, timestamp) => timestamp */ 
DATA(insert OID = 6079 ( linear_interpolate  PGNSP PGUID 12 f f t f i 5 1114 f "2283 2283 1114 2283 1114" _null_ _null_ _null_ linterp_Timestamp - _null_ n ));
DESCR("linear interpolation: x, x0,y0, x1,y1");

/* linear_interpolate( anyelement, anyelement, timestamptz, anyelement, timestamptz) => timestamptz */ 
DATA(insert OID = 6080 ( linear_interpolate  PGNSP PGUID 12 f f t f i 5 1184 f "2283 2283 1184 2283 1184" _null_ _null_ _null_ linterp_TimestampTz - _null_ n ));
DESCR("linear interpolation: x, x0,y0, x1,y1");

/* linear_interpolate( anyelement, anyelement, "interval", anyelement, "interval") => "interval" */ 
DATA(insert OID = 6081 ( linear_interpolate  PGNSP PGUID 12 f f t f i 5 1186 f "2283 2283 1186 2283 1186" _null_ _null_ _null_ linterp_Interval - _null_ n ));
DESCR("linear interpolation: x, x0,y0, x1,y1");

/* linear_interpolate( anyelement, anyelement, "numeric", anyelement, "numeric") => "numeric" */ 
DATA(insert OID = 6082 ( linear_interpolate  PGNSP PGUID 12 f f t f i 5 1700 f "2283 2283 1700 2283 1700" _null_ _null_ _null_ linterp_Numeric - _null_ n ));
DESCR("linear interpolation: x, x0,y0, x1,y1");

/* lead_lag_frame_maker(internal) => internal */ 
DATA(insert OID = 5081 ( lead_lag_frame_maker  PGNSP PGUID 12 f f t f v 1 2281 f "2281" _null_ _null_ _null_ lead_lag_frame_maker - _null_ n ));
