...
DATA(insert OID = 5066 ( array_add  PGNSP PGUID 12 1 0 0 0 f f f f t f i 2 0 1007 "1007 1007" _null_ _null_ _null_ _null_ _null_ array_int4_add _null_ _null_ _null_ n a ));
...
DATA(insert OID = 5067 ( array_sum  PGNSP PGUID 12 1 0 0 0 t f f f f f i 1 0 1007 "1007" _null_ _null_ _null_ _null_ _null_ aggregate_dummy _null_ _null_ _null_ n a ));
DESCR("array sum aggregate");


/* Greenplum Analytic functions */
/* int2_matrix_accum(_int8, _int2) => _int8 */
DATA(insert OID = 6212 ( int2_matrix_accum  PGNSP PGUID 12 1 0 0 0 f f f f f f i 2 0 1016 "1016 1005" _null_ _null_ _null_ _null_ _null_ matrix_add _null_ _null_ _null_ n a ));
DESCR("perform matrix addition on two conformable matrices");

/* int4_matrix_accum(_int8, _int4) => _int8 */
DATA(insert OID = 6213 ( int4_matrix_accum  PGNSP PGUID 12 1 0 0 0 f f f f f f i 2 0 1016 "1016 1007" _null_ _null_ _null_ _null_ _null_ matrix_add _null_ _null_ _null_ n a ));
DESCR("perform matrix addition on two conformable matrices");

/* int8_matrix_accum(_int8, _int8) => _int8 */
DATA(insert OID = 6214 ( int8_matrix_accum  PGNSP PGUID 12 1 0 0 0 f f f f t f i 2 0 1016 "1016 1016" _null_ _null_ _null_ _null_ _null_ matrix_add _null_ _null_ _null_ n a ));
DESCR("perform matrix addition on two conformable matrices");

/* float8_matrix_accum(_float8, _float8) => _float8 */
DATA(insert OID = 6215 ( float8_matrix_accum  PGNSP PGUID 12 1 0 0 0 f f f f t f i 2 0 1022 "1022 1022" _null_ _null_ _null_ _null_ _null_ matrix_add _null_ _null_ _null_ n a ));
DESCR("perform matrix addition on two conformable matrices");

/* sum(_int2) => _int8 */
DATA(insert OID = 6216 ( sum  PGNSP PGUID 12 1 0 0 0 t f f f f f i 1 0 1016 "1005" _null_ _null_ _null_ _null_ _null_ aggregate_dummy _null_ _null_ _null_ n a ));
DESCR("sum of matrixes");

/* sum(_int4) => _int8 */
DATA(insert OID = 6217 ( sum  PGNSP PGUID 12 1 0 0 0 t f f f f f i 1 0 1016 "1007" _null_ _null_ _null_ _null_ _null_ aggregate_dummy _null_ _null_ _null_ n a ));
DESCR("sum of matrixes");

/* sum(_int8) => _int8 */
DATA(insert OID = 6218 ( sum  PGNSP PGUID 12 1 0 0 0 t f f f f f i 1 0 1016 "1016" _null_ _null_ _null_ _null_ _null_ aggregate_dummy _null_ _null_ _null_ n a ));
DESCR("sum of matrixes");

/* sum(_float8) => _float8 */
DATA(insert OID = 6219 ( sum  PGNSP PGUID 12 1 0 0 0 t f f f f f i 1 0 1022 "1022" _null_ _null_ _null_ _null_ _null_ aggregate_dummy _null_ _null_ _null_ n a ));
DESCR("sum of matrixes");


/* 3220 - reserved for sum(numeric[])  */
/* int4_pivot_accum(_int4, _text, text, int4) => _int4 */
DATA(insert OID = 6225 ( int4_pivot_accum  PGNSP PGUID 12 1 0 0 0 f f f f f f i 4 0 1007 "1007 1009 25 23" _null_ _null_ _null_ _null_ _null_ int4_pivot_accum _null_ _null_ _null_ n a ));
DESCR("aggregate transition function");

/* pivot_sum(_text, text, int4) => _int4 */
DATA(insert OID = 6226 ( pivot_sum  PGNSP PGUID 12 1 0 0 0 t f f f f f i 3 0 1007 "1009 25 23" _null_ _null_ _null_ _null_ _null_ aggregate_dummy _null_ _null_ _null_ n a ));
DESCR("pivot sum aggregate");

/* int8_pivot_accum(_int8, _text, text, int8) => _int8 */
DATA(insert OID = 6227 ( int8_pivot_accum  PGNSP PGUID 12 1 0 0 0 f f f f f f i 4 0 1016 "1016 1009 25 20" _null_ _null_ _null_ _null_ _null_ int8_pivot_accum _null_ _null_ _null_ n a ));
DESCR("aggregate transition function");

/* pivot_sum(_text, text, int8) => _int8 */
DATA(insert OID = 6228 ( pivot_sum  PGNSP PGUID 12 1 0 0 0 t f f f f f i 3 0 1016 "1009 25 20" _null_ _null_ _null_ _null_ _null_ aggregate_dummy _null_ _null_ _null_ n a ));
DESCR("pivot sum aggregate");

/* float8_pivot_accum(_float8, _text, text, float8) => _float8 */
DATA(insert OID = 6229 ( float8_pivot_accum  PGNSP PGUID 12 1 0 0 0 f f f f f f i 4 0 1022 "1022 1009 25 701" _null_ _null_ _null_ _null_ _null_ float8_pivot_accum _null_ _null_ _null_ n a ));
DESCR("aggregate transition function");

/* pivot_sum(_text, text, float8) => _float8 */
DATA(insert OID = 6230 ( pivot_sum  PGNSP PGUID 12 1 0 0 0 t f f f f f i 3 0 1022 "1009 25 701" _null_ _null_ _null_ _null_ _null_ aggregate_dummy _null_ _null_ _null_ n a ));
DESCR("pivot sum aggregate");
...
DATA(insert OID = 5065 ( gp_pgdatabase  PGNSP PGUID 12 1 1000 0 0 f f f f f t v 0 0 2249 "" _null_ _null_ _null_ _null_ _null_ gp_pgdatabase__ _null_ _null_ _null_ n a ));
...
DATA(insert OID = 7169 ( get_ao_distribution  PGNSP PGUID 12 1 1000 0 0 f f f f f t v 1 0 2249 "2205" "{2205,23,20}" "{i,o,o}" "{rel,segmentid,tupcount}" _null_ _null_ get_ao_distribution _null_ _null_ _null_ r a ));
DESCR("show append only table tuple distribution across segment databases");

/* get_ao_compression_ratio(regclass) => float8 */
DATA(insert OID = 7171 ( get_ao_compression_ratio  PGNSP PGUID 12 1 0 0 0 f f f f t f v 1 0 701 "2205" _null_ _null_ _null_ _null_ _null_ get_ao_compression_ratio _null_ _null_ _null_ r a ));
DESCR("show append only table compression ratio");

/* gp_update_ao_master_stats(regclass) => int8 */
DATA(insert OID = 7173 ( gp_update_ao_master_stats  PGNSP PGUID 12 1 0 0 0 f f f f f f v 1 0 20 "2205" _null_ _null_ _null_ _null_ _null_ gp_update_ao_master_stats _null_ _null_ _null_ m a ));
...
DATA(insert OID = 7196 ( bmcostestimate  PGNSP PGUID 12 1 0 0 0 f f f f t f v 7 0 2278 "2281 2281 2281 2281 2281 2281 2281" _null_ _null_ _null_ _null_ _null_ bmcostestimate _null_ _null_ _null_ n a ));
DESCR("bitmap(internal)");
...
DATA(insert OID = 6038 ( gp_acquire_sample_rows  PGNSP PGUID 12 1 1000 0 0 f f f f t t v 3 0 2249 "26 23 16" _null_ _null_ _null_ _null_ _null_ gp_acquire_sample_rows _null_ _null_ _null_ n s ));
...
DATA(insert OID = 5080 ( gp_expand_lock_catalog  PGNSP PGUID 12 1 0 0 0 f f f f f f v 0 0 2278 "" _null_ _null_ _null_ _null_ _null_ gp_expand_lock_catalog _null_ _null_ _null_ n a ));
DESCR("Lock catalog changes for gpexpand");

/* gp_expand_bump_version() => void */
DATA(insert OID = 5081 ( gp_expand_bump_version  PGNSP PGUID 12 1 0 0 0 f f f f f f v 0 0 2278 "" _null_ _null_ _null_ _null_ _null_ gp_expand_bump_version _null_ _null_ _null_ n a ));
...
DATA(insert OID = 6548 ( complex_out  PGNSP PGUID 12 1 0 0 0 f f f f t f i 1 0 2275 "7198" _null_ _null_ _null_ _null_ _null_ complex_out _null_ _null_ _null_ n a ));
DESCR("I/O");

/* complex_recv(internal) => complex */
DATA(insert OID = 6549 ( complex_recv  PGNSP PGUID 12 1 0 0 0 f f f f t f i 1 0 7198 "2281" _null_ _null_ _null_ _null_ _null_ complex_recv _null_ _null_ _null_ n a ));
DESCR("I/O");

/* complex_send(complex) => bytea */
DATA(insert OID = 6550 ( complex_send  PGNSP PGUID 12 1 0 0 0 f f f f t f i 1 0 17 "7198" _null_ _null_ _null_ _null_ _null_ complex_send _null_ _null_ _null_ n a ));
DESCR("I/O");

/* complex(float8, float8) => complex */
DATA(insert OID = 6551 ( complex  PGNSP PGUID 12 1 0 0 0 f f f f t f i 2 0 7198 "701 701" _null_ _null_ _null_ _null_ _null_ construct_complex _null_ _null_ _null_ n a ));
DESCR("constructs a complex number with given real part and imaginary part");

/* complex_trig(float8, float8) => complex */
DATA(insert OID = 6552 ( complex_trig  PGNSP PGUID 12 1 0 0 0 f f f f t f i 2 0 7198 "701 701" _null_ _null_ _null_ _null_ _null_ construct_complex_trig _null_ _null_ _null_ n a ));
DESCR("constructs a complex number with given magnitude and phase");

/* re(complex) => float8 */
DATA(insert OID = 6553 ( re  PGNSP PGUID 12 1 0 0 0 f f f f t f i 1 0 701 "7198" _null_ _null_ _null_ _null_ _null_ complex_re _null_ _null_ _null_ n a ));
DESCR("returns the real part of the argument");

/* im(complex) => float8 */
DATA(insert OID = 6554 ( im  PGNSP PGUID 12 1 0 0 0 f f f f t f i 1 0 701 "7198" _null_ _null_ _null_ _null_ _null_ complex_im _null_ _null_ _null_ n a ));
DESCR("returns the imaginary part of the argument");

/* radians(complex) => float8 */
DATA(insert OID = 6555 ( radians  PGNSP PGUID 12 1 0 0 0 f f f f t f i 1 0 701 "7198" _null_ _null_ _null_ _null_ _null_ complex_arg _null_ _null_ _null_ n a ));
DESCR("returns the phase of the argument");

/* complexabs(complex) => float8 */
DATA(insert OID = 6556 ( complexabs  PGNSP PGUID 12 1 0 0 0 f f f f t f i 1 0 701 "7198" _null_ _null_ _null_ _null_ _null_ complex_mag _null_ _null_ _null_ n a ));

/* abs(complex) => float8 */
DATA(insert OID = 6557 ( abs  PGNSP PGUID 12 1 0 0 0 f f f f t f i 1 0 701 "7198" _null_ _null_ _null_ _null_ _null_ complex_mag _null_ _null_ _null_ n a ));
DESCR("returns the magnitude of the argument");

/* conj(complex) => complex */
DATA(insert OID = 6558 ( conj  PGNSP PGUID 12 1 0 0 0 f f f f t f i 1 0 7198 "7198" _null_ _null_ _null_ _null_ _null_ complex_conj _null_ _null_ _null_ n a ));
DESCR("returns the conjunction of the argument");

/* hashcomplex(complex) => int4 */
DATA(insert OID = 6559 ( hashcomplex  PGNSP PGUID 12 1 0 0 0 f f f f t f i 1 0 23 "7198" _null_ _null_ _null_ _null_ _null_ complex_hash _null_ _null_ _null_ n a ));
DESCR("hash");

/* complex_eq(complex, complex) => bool */
DATA(insert OID = 6560 ( complex_eq  PGNSP PGUID 12 1 0 0 0 f f f f t f i 2 0 16 "7198 7198" _null_ _null_ _null_ _null_ _null_ complex_eq _null_ _null_ _null_ n a ));

/* complex_ne(complex, complex) => bool */
DATA(insert OID = 6561 ( complex_ne  PGNSP PGUID 12 1 0 0 0 f f f f t f i 2 0 16 "7198 7198" _null_ _null_ _null_ _null_ _null_ complex_ne _null_ _null_ _null_ n a ));

/* complex_pl(complex, complex) => complex */
DATA(insert OID = 6562 ( complex_pl  PGNSP PGUID 12 1 0 0 0 f f f f t f i 2 0 7198 "7198 7198" _null_ _null_ _null_ _null_ _null_ complex_pl _null_ _null_ _null_ n a ));

/* complex_up(complex) => complex */
DATA(insert OID = 6563 ( complex_up  PGNSP PGUID 12 1 0 0 0 f f f f t f i 1 0 7198 "7198" _null_ _null_ _null_ _null_ _null_ complex_up _null_ _null_ _null_ n a ));

/* complex_mi(complex, complex) => complex */
DATA(insert OID = 6564 ( complex_mi  PGNSP PGUID 12 1 0 0 0 f f f f t f i 2 0 7198 "7198 7198" _null_ _null_ _null_ _null_ _null_ complex_mi _null_ _null_ _null_ n a ));

/* complex_um(complex) => complex */
DATA(insert OID = 6565 ( complex_um  PGNSP PGUID 12 1 0 0 0 f f f f t f i 1 0 7198 "7198" _null_ _null_ _null_ _null_ _null_ complex_um _null_ _null_ _null_ n a ));

/* complex_mul(complex, complex) => complex */
DATA(insert OID = 6566 ( complex_mul  PGNSP PGUID 12 1 0 0 0 f f f f t f i 2 0 7198 "7198 7198" _null_ _null_ _null_ _null_ _null_ complex_mul _null_ _null_ _null_ n a ));

/* complex_div(complex, complex) => complex */
DATA(insert OID = 6567 ( complex_div  PGNSP PGUID 12 1 0 0 0 f f f f t f i 2 0 7198 "7198 7198" _null_ _null_ _null_ _null_ _null_ complex_div _null_ _null_ _null_ n a ));

/* complex_power(complex, complex) => complex */
DATA(insert OID = 6568 ( complex_power  PGNSP PGUID 12 1 0 0 0 f f f f t f i 2 0 7198 "7198 7198" _null_ _null_ _null_ _null_ _null_ complex_pow _null_ _null_ _null_ n a ));

/* complex_sqrt(complex) => complex */
DATA(insert OID = 6569 ( complex_sqrt  PGNSP PGUID 12 1 0 0 0 f f f f t f i 1 0 7198 "7198" _null_ _null_ _null_ _null_ _null_ complex_sqrt _null_ _null_ _null_ n a ));

/* complex_cbrt(complex) => complex */
DATA(insert OID = 6570 ( complex_cbrt  PGNSP PGUID 12 1 0 0 0 f f f f t f i 1 0 7198 "7198" _null_ _null_ _null_ _null_ _null_ complex_cbrt _null_ _null_ _null_ n a ));

/* degrees(complex) => float8 */
DATA(insert OID = 6571 ( degrees  PGNSP PGUID 12 1 0 0 0 f f f f t f i 1 0 701 "7198" _null_ _null_ _null_ _null_ _null_ complex_degrees _null_ _null_ _null_ n a ));
DESCR("phase to degrees");

/* exp(complex) => complex */
DATA(insert OID = 6572 ( exp  PGNSP PGUID 12 1 0 0 0 f f f f t f i 1 0 7198 "7198" _null_ _null_ _null_ _null_ _null_ complex_exp _null_ _null_ _null_ n a ));
DESCR("natural exponential (e^x)");

/* ln(complex) => complex */
DATA(insert OID = 5031 ( ln  PGNSP PGUID 12 1 0 0 0 f f f f t f i 1 0 7198 "7198" _null_ _null_ _null_ _null_ _null_ complex_ln _null_ _null_ _null_ n a ));
DESCR("natural logarithm");

/* log(complex) => complex */
DATA(insert OID = 5032 ( log  PGNSP PGUID 12 1 0 0 0 f f f f t f i 1 0 7198 "7198" _null_ _null_ _null_ _null_ _null_ complex_log10 _null_ _null_ _null_ n a ));
DESCR("base 10 logarithm");

/* log(complex, complex) => complex */
DATA(insert OID = 5033 ( log  PGNSP PGUID 12 1 0 0 0 f f f f t f i 2 0 7198 "7198 7198" _null_ _null_ _null_ _null_ _null_ complex_log _null_ _null_ _null_ n a ));
DESCR("logarithm base arg1 of arg2");

/* acos(complex) => complex */
DATA(insert OID = 5053 ( acos  PGNSP PGUID 12 1 0 0 0 f f f f t f i 1 0 7198 "7198" _null_ _null_ _null_ _null_ _null_ complex_acos _null_ _null_ _null_ n a ));
DESCR("acos");
...
/* cot(complex) => complex */
DATA(insert OID = 5052 ( cot  PGNSP PGUID 12 1 0 0 0 f f f f t f i 1 0 7198 "7198" _null_ _null_ _null_ _null_ _null_ complex_cot _null_ _null_ _null_ n a ));
DESCR("cot");

/* sin(complex) => complex */
DATA(insert OID = 5054 ( sin  PGNSP PGUID 12 1 0 0 0 f f f f t f i 1 0 7198 "7198" _null_ _null_ _null_ _null_ _null_ complex_sin _null_ _null_ _null_ n a ));
DESCR("sin");

/* tan(complex) => complex */
DATA(insert OID = 5055 ( tan  PGNSP PGUID 12 1 0 0 0 f f f f t f i 1 0 7198 "7198" _null_ _null_ _null_ _null_ _null_ complex_tan _null_ _null_ _null_ n a ));
DESCR("tan");

/* dotproduct(_complex, _complex) => complex */
DATA(insert OID = 5056 ( dotproduct  PGNSP PGUID 12 1 0 0 0 f f f f t f i 2 0 7198 "7199 7199" _null_ _null_ _null_ _null_ _null_ complex_dot_product _null_ _null_ _null_ n a ));
DESCR("dot product");

/* float82complex(float8) => complex */
DATA(insert OID = 5057 ( float82complex  PGNSP PGUID 12 1 0 0 0 f f f f t f i 1 0 7198 "701" _null_ _null_ _null_ _null_ _null_ float82complex _null_ _null_ _null_ n a ));
DESCR("(internal) type cast from float8 to complex");

/* float42complex(float4) => complex */
DATA(insert OID = 5058 ( float42complex  PGNSP PGUID 12 1 0 0 0 f f f f t f i 1 0 7198 "700" _null_ _null_ _null_ _null_ _null_ float42complex _null_ _null_ _null_ n a ));
DESCR("(internal) type cast from float4 to complex");

/* int82complex(int8) => complex */
DATA(insert OID = 5059 ( int82complex  PGNSP PGUID 12 1 0 0 0 f f f f t f i 1 0 7198 "20" _null_ _null_ _null_ _null_ _null_ int82complex _null_ _null_ _null_ n a ));
DESCR("(internal) type cast from int8 to complex");

/* int42complex(int4) => complex */
DATA(insert OID = 5060 ( int42complex  PGNSP PGUID 12 1 0 0 0 f f f f t f i 1 0 7198 "23" _null_ _null_ _null_ _null_ _null_ int42complex _null_ _null_ _null_ n a ));
DESCR("(internal) type cast from int4 to complex");

/* int22complex(int2) => complex */
DATA(insert OID = 5061 ( int22complex  PGNSP PGUID 12 1 0 0 0 f f f f t f i 1 0 7198 "21" _null_ _null_ _null_ _null_ _null_ int22complex _null_ _null_ _null_ n a ));
DESCR("(internal) type cast from int2 to complex");

/* power(complex, complex) => complex */
DATA(insert OID = 5062 ( power  PGNSP PGUID 12 1 0 0 0 f f f f t f i 2 0 7198 "7198 7198" _null_ _null_ _null_ _null_ _null_ complex_pow _null_ _null_ _null_ n a ));
DESCR("exponentiation (x^y)");

/* sqrt(complex) => complex */
DATA(insert OID = 5063 ( sqrt  PGNSP PGUID 12 1 0 0 0 f f f f t f i 1 0 7198 "7198" _null_ _null_ _null_ _null_ _null_ complex_sqrt _null_ _null_ _null_ n a ));
DESCR("squre root");

/* cbrt(complex) => complex */
DATA(insert OID = 5064 ( cbrt  PGNSP PGUID 12 1 0 0 0 f f f f t f i 1 0 7198 "7198" _null_ _null_ _null_ _null_ _null_ complex_cbrt _null_ _null_ _null_ n a ));
DESCR("cube root");

/* numeric2point("numeric") => complex */
DATA(insert OID = 7597 ( numeric2point  PGNSP PGUID 12 1 0 0 0 f f f f t f i 1 0 7198 "1700" _null_ _null_ _null_ _null_ _null_ numeric2complex _null_ _null_ _null_ n a ));
DESCR("(internal) type cast from numeric to complex");

/* complex_lt(complex, complex) => bool */
DATA(insert OID = 7598 ( complex_lt  PGNSP PGUID 12 1 0 0 0 f f f f t f i 2 0 16 "7198 7198" _null_ _null_ _null_ _null_ _null_ complex_lt _null_ _null_ _null_ n a ));

/* complex_gt(complex, complex) => bool */
DATA(insert OID = 6594 ( complex_gt  PGNSP PGUID 12 1 0 0 0 f f f f t f i 2 0 16 "7198 7198" _null_ _null_ _null_ _null_ _null_ complex_gt _null_ _null_ _null_ n a ));

/* complex_lte(complex, complex) => bool */
DATA(insert OID = 6595 ( complex_lte  PGNSP PGUID 12 1 0 0 0 f f f f t f i 2 0 16 "7198 7198" _null_ _null_ _null_ _null_ _null_ complex_lte _null_ _null_ _null_ n a ));
...
DATA(insert OID = 7158 ( gp_hyperloglog_in  PGNSP PGUID 12 1 0 0 0 f f f f t f i 1 0 7157 "2275" _null_ _null_ "{value}" _null_ _null_ gp_hyperloglog_in _null_ _null_ _null_ n a ));
DESCR("Decode a bytea into gp_hyperloglog counter");

/* gp_hyperloglog_out(counter gp_hyperloglog_estimator) => cstring */
DATA(insert OID = 7159 ( gp_hyperloglog_out  PGNSP PGUID 12 1 0 0 0 f f f f t f i 1 0 2275 "7157" _null_ _null_ "{counter}" _null_ _null_ gp_hyperloglog_out _null_ _null_ _null_ n a ));
...
DATA(insert OID = 7160 ( gp_hyperloglog_comp  PGNSP PGUID 12 1 0 0 0 f f f f t f i 1 0 7157 "7157" _null_ _null_ "{counter}" _null_ _null_ gp_hyperloglog_comp _null_ _null_ _null_ n a ));
...
DATA(insert OID = 7161 ( gp_hyperloglog_merge  PGNSP PGUID 12 1 0 0 0 f f f f f f i 2 0 7157 "7157 7157" _null_ _null_ "{estimator1,estimator2}" _null_ _null_ gp_hyperloglog_merge _null_ _null_ _null_ n a ));
DESCR("Merge two gp_hyperloglog counters into one");

/* gp_hyperloglog_get_estimate(counter gp_hyperloglog_estimator) => float8 */
DATA(insert OID = 7162 ( gp_hyperloglog_get_estimate  PGNSP PGUID 12 1 0 0 0 f f f f t f i 1 0 701 "7157" _null_ _null_ "{counter}" _null_ _null_ gp_hyperloglog_get_estimate _null_ _null_ _null_ n a ));
...
DATA(insert OID = 7163 ( gp_hyperloglog_add_item_agg_default  PGNSP PGUID 12 1 0 0 0 f f f f f f i 2 0 7157 "7157 2283" _null_ _null_ "{counter,item}" _null_ _null_ gp_hyperloglog_add_item_agg_default _null_ _null_ _null_ n a ));
DESCR("Includes a data value into a gp_hyperloglog counter");

/* gp_hyperloglog_accum(anyelement) => gp_hyperloglog_estimator */
DATA(insert OID = 7164 ( gp_hyperloglog_accum  PGNSP PGUID 12 1 0 0 0 t f f f f f i 1 0 7157 "2283" _null_ _null_ _null_ _null_ _null_ aggregate_dummy _null_ _null_ _null_ n a ));
DESCR("Adds every data value to a gp_hyperloglog counter and returns the counter");

/* pg_get_table_distributedby(oid) => text */
DATA(insert OID = 6232 ( pg_get_table_distributedby  PGNSP PGUID 12 1 0 0 0 f f f f t f s 1 0 25 "26" _null_ _null_ _null_ _null_ _null_ pg_get_table_distributedby _null_ _null_ _null_ n a ));
...
/* hashtid(tid) => int4 */
DATA(insert OID = 6114 ( hashtid  PGNSP PGUID 12 1 0 0 0 f f f f t f i 1 0 23 "27" _null_ _null_ _null_ _null_ _null_ hashtid _null_ _null_ _null_ n a ));
DESCR("hash function for tid");

/* bithash(bit) => int4 */
DATA(insert OID = 6117 ( bithash  PGNSP PGUID 12 1 0 0 0 f f f f t f i 1 0 23 "1560" _null_ _null_ _null_ _null_ _null_ bithash _null_ _null_ _null_ n a ));
DESCR("hash function for bit");

/* bithash(varbit) => int4 */
DATA(insert OID = 6118 ( bithash  PGNSP PGUID 12 1 0 0 0 f f f f t f i 1 0 23 "1562" _null_ _null_ _null_ _null_ _null_ bithash _null_ _null_ _null_ n a ));
DESCR("hash function for bit varbit");


/* Legacy cdbhash functions. */
/* cdblegacyhash_int2(int2) => int4 */
DATA(insert OID = 6140 ( cdblegacyhash_int2  PGNSP PGUID 12 1 0 0 0 f f f f t f i 1 0 23 "21" _null_ _null_ _null_ _null_ _null_ cdblegacyhash_int2 _null_ _null_ _null_ n a ));
DESCR("Legacy cdbhash function");

/* cdblegacyhash_int4(int4) => int4 */
DATA(insert OID = 6141 ( cdblegacyhash_int4  PGNSP PGUID 12 1 0 0 0 f f f f t f i 1 0 23 "23" _null_ _null_ _null_ _null_ _null_ cdblegacyhash_int4 _null_ _null_ _null_ n a ));
DESCR("Legacy cdbhash function");

/* cdblegacyhash_int8(int8) => int4 */
DATA(insert OID = 6142 ( cdblegacyhash_int8  PGNSP PGUID 12 1 0 0 0 f f f f t f i 1 0 23 "20" _null_ _null_ _null_ _null_ _null_ cdblegacyhash_int8 _null_ _null_ _null_ n a ));
DESCR("Legacy cdbhash function");

/* cdblegacyhash_float4(float4) => int4 */
DATA(insert OID = 6143 ( cdblegacyhash_float4  PGNSP PGUID 12 1 0 0 0 f f f f t f i 1 0 23 "700" _null_ _null_ _null_ _null_ _null_ cdblegacyhash_float4 _null_ _null_ _null_ n a ));
DESCR("Legacy cdbhash function");

/* cdblegacyhash_float8(float8) => int4 */
DATA(insert OID = 6144 ( cdblegacyhash_float8  PGNSP PGUID 12 1 0 0 0 f f f f t f i 1 0 23 "701" _null_ _null_ _null_ _null_ _null_ cdblegacyhash_float8 _null_ _null_ _null_ n a ));
DESCR("Legacy cdbhash function");

/* cdblegacyhash_numeric(numeric) => int4 */
DATA(insert OID = 6145 ( cdblegacyhash_numeric  PGNSP PGUID 12 1 0 0 0 f f f f t f i 1 0 23 "1700" _null_ _null_ _null_ _null_ _null_ cdblegacyhash_numeric _null_ _null_ _null_ n a ));
DESCR("Legacy cdbhash function");

/* cdblegacyhash_char(char) => int4 */
DATA(insert OID = 6146 ( cdblegacyhash_char  PGNSP PGUID 12 1 0 0 0 f f f f t f i 1 0 23 "18" _null_ _null_ _null_ _null_ _null_ cdblegacyhash_char _null_ _null_ _null_ n a ));
DESCR("Legacy cdbhash function");

/* cdblegacyhash_text(text) => int4 */
DATA(insert OID = 6147 ( cdblegacyhash_text  PGNSP PGUID 12 1 0 0 0 f f f f t f i 1 0 23 "25" _null_ _null_ _null_ _null_ _null_ cdblegacyhash_text _null_ _null_ _null_ n a ));
DESCR("Legacy cdbhash function");

/* cdblegacyhash_bpchar(bpchar) => int4 */
DATA(insert OID = 6148 ( cdblegacyhash_bpchar  PGNSP PGUID 12 1 0 0 0 f f f f t f i 1 0 23 "1042" _null_ _null_ _null_ _null_ _null_ cdblegacyhash_text _null_ _null_ _null_ n a ));
DESCR("Legacy cdbhash function");

/* cdblegacyhash_bytea(bytea) => int4 */
DATA(insert OID = 6149 ( cdblegacyhash_bytea  PGNSP PGUID 12 1 0 0 0 f f f f t f i 1 0 23 "17" _null_ _null_ _null_ _null_ _null_ cdblegacyhash_bytea _null_ _null_ _null_ n a ));
DESCR("Legacy cdbhash function");

/* cdblegacyhash_name(name) => int4 */
DATA(insert OID = 6150 ( cdblegacyhash_name  PGNSP PGUID 12 1 0 0 0 f f f f t f i 1 0 23 "19" _null_ _null_ _null_ _null_ _null_ cdblegacyhash_name _null_ _null_ _null_ n a ));
DESCR("Legacy cdbhash function");

/* cdblegacyhash_oid(oid) => int4 */
DATA(insert OID = 6151 ( cdblegacyhash_oid  PGNSP PGUID 12 1 0 0 0 f f f f t f i 1 0 23 "26" _null_ _null_ _null_ _null_ _null_ cdblegacyhash_oid _null_ _null_ _null_ n a ));
DESCR("Legacy cdbhash function");

/* cdblegacyhash_tid(tid) => int4 */
DATA(insert OID = 6152 ( cdblegacyhash_tid  PGNSP PGUID 12 1 0 0 0 f f f f t f i 1 0 23 "27" _null_ _null_ _null_ _null_ _null_ cdblegacyhash_tid _null_ _null_ _null_ n a ));
DESCR("Legacy cdbhash function");

/* cdblegacyhash_timestamp(timestamp) => int4 */
DATA(insert OID = 6153 ( cdblegacyhash_timestamp  PGNSP PGUID 12 1 0 0 0 f f f f t f i 1 0 23 "1114" _null_ _null_ _null_ _null_ _null_ cdblegacyhash_timestamp _null_ _null_ _null_ n a ));
DESCR("Legacy cdbhash function");

/* cdblegacyhash_timestamptz(timestamptz) => int4 */
DATA(insert OID = 6154 ( cdblegacyhash_timestamptz  PGNSP PGUID 12 1 0 0 0 f f f f t f i 1 0 23 "1184" _null_ _null_ _null_ _null_ _null_ cdblegacyhash_timestamptz _null_ _null_ _null_ n a ));
DESCR("Legacy cdbhash function");

/* cdblegacyhash_date(date) => int4 */
DATA(insert OID = 6155 ( cdblegacyhash_date  PGNSP PGUID 12 1 0 0 0 f f f f t f i 1 0 23 "1082" _null_ _null_ _null_ _null_ _null_ cdblegacyhash_date _null_ _null_ _null_ n a ));
DESCR("Legacy cdbhash function");

/* cdblegacyhash_time(time) => int4 */
DATA(insert OID = 6156 ( cdblegacyhash_time  PGNSP PGUID 12 1 0 0 0 f f f f t f i 1 0 23 "1083" _null_ _null_ _null_ _null_ _null_ cdblegacyhash_time _null_ _null_ _null_ n a ));
DESCR("Legacy cdbhash function");

/* cdblegacyhash_timetz(timetz) => int4 */
DATA(insert OID = 6157 ( cdblegacyhash_timetz  PGNSP PGUID 12 1 0 0 0 f f f f t f i 1 0 23 "1266" _null_ _null_ _null_ _null_ _null_ cdblegacyhash_timetz _null_ _null_ _null_ n a ));
DESCR("Legacy cdbhash function");

/* cdblegacyhash_interval(interval) => int4 */
DATA(insert OID = 6158 ( cdblegacyhash_interval  PGNSP PGUID 12 1 0 0 0 f f f f t f i 1 0 23 "1186" _null_ _null_ _null_ _null_ _null_ cdblegacyhash_interval _null_ _null_ _null_ n a ));
DESCR("Legacy cdbhash function");

/* cdblegacyhash_abstime(abstime) => int4 */
DATA(insert OID = 6159 ( cdblegacyhash_abstime  PGNSP PGUID 12 1 0 0 0 f f f f t f i 1 0 23 "702" _null_ _null_ _null_ _null_ _null_ cdblegacyhash_abstime _null_ _null_ _null_ n a ));
DESCR("Legacy cdbhash function");

/* cdblegacyhash_reltime(reltime) => int4 */
DATA(insert OID = 6160 ( cdblegacyhash_reltime  PGNSP PGUID 12 1 0 0 0 f f f f t f i 1 0 23 "703" _null_ _null_ _null_ _null_ _null_ cdblegacyhash_reltime _null_ _null_ _null_ n a ));
DESCR("Legacy cdbhash function");

/* cdblegacyhash_tinterval(tinterval) => int4 */
DATA(insert OID = 6161 ( cdblegacyhash_tinterval  PGNSP PGUID 12 1 0 0 0 f f f f t f i 1 0 23 "704" _null_ _null_ _null_ _null_ _null_ cdblegacyhash_tinterval _null_ _null_ _null_ n a ));
DESCR("Legacy cdbhash function");

/* cdblegacyhash_inet(inet) => int4 */
DATA(insert OID = 6162 ( cdblegacyhash_inet  PGNSP PGUID 12 1 0 0 0 f f f f t f i 1 0 23 "869" _null_ _null_ _null_ _null_ _null_ cdblegacyhash_inet _null_ _null_ _null_ n a ));
DESCR("Legacy cdbhash function");

/* cdblegacyhash_macaddr(macaddr) => int4 */
DATA(insert OID = 6163 ( cdblegacyhash_macaddr  PGNSP PGUID 12 1 0 0 0 f f f f t f i 1 0 23 "829" _null_ _null_ _null_ _null_ _null_ cdblegacyhash_macaddr _null_ _null_ _null_ n a ));
DESCR("Legacy cdbhash function");

/* cdblegacyhash_bit(bit) => int4 */
DATA(insert OID = 6164 ( cdblegacyhash_bit  PGNSP PGUID 12 1 0 0 0 f f f f t f i 1 0 23 "1560" _null_ _null_ _null_ _null_ _null_ cdblegacyhash_bit _null_ _null_ _null_ n a ));
DESCR("Legacy cdbhash function");

/* cdblegacyhash_bool(bool) => int4 */
DATA(insert OID = 6165 ( cdblegacyhash_bool  PGNSP PGUID 12 1 0 0 0 f f f f t f i 1 0 23 "16" _null_ _null_ _null_ _null_ _null_ cdblegacyhash_bool _null_ _null_ _null_ n a ));
DESCR("Legacy cdbhash function");

/* cdblegacyhash_array(anyarray) => int4 */
DATA(insert OID = 6166 ( cdblegacyhash_array  PGNSP PGUID 12 1 0 0 0 f f f f t f i 1 0 23 "2277" _null_ _null_ _null_ _null_ _null_ cdblegacyhash_array _null_ _null_ _null_ n a ));
DESCR("Legacy cdbhash function");

/* cdblegacyhash_oidvector(oidvector) => int4 */
DATA(insert OID = 6167 ( cdblegacyhash_oidvector  PGNSP PGUID 12 1 0 0 0 f f f f t f i 1 0 23 "30" _null_ _null_ _null_ _null_ _null_ cdblegacyhash_oidvector _null_ _null_ _null_ n a ));
DESCR("Legacy cdbhash function");

/* cdblegacyhash_cash(money) => int4 */
DATA(insert OID = 6168 ( cdblegacyhash_cash  PGNSP PGUID 12 1 0 0 0 f f f f t f i 1 0 23 "790" _null_ _null_ _null_ _null_ _null_ cdblegacyhash_cash _null_ _null_ _null_ n a ));
DESCR("Legacy cdbhash function");

/* cdblegacyhash_complex(complex) => int4 */
DATA(insert OID = 6169 ( cdblegacyhash_complex  PGNSP PGUID 12 1 0 0 0 f f f f t f i 1 0 23 "7198" _null_ _null_ _null_ _null_ _null_ cdblegacyhash_complex _null_ _null_ _null_ n a ));
DESCR("Legacy cdbhash function");

/* cdblegacyhash_uuid(uuid) => int4 */
DATA(insert OID = 6170 ( cdblegacyhash_uuid  PGNSP PGUID 12 1 0 0 0 f f f f t f i 1 0 23 "2950" _null_ _null_ _null_ _null_ _null_ cdblegacyhash_uuid _null_ _null_ _null_ n a ));
DESCR("Legacy cdbhash function");

/* cdblegacyhash_anyenum(anyenum) => int4 */
DATA(insert OID = 6171 ( cdblegacyhash_anyenum  PGNSP PGUID 12 1 0 0 0 f f f f t f i 1 0 23 "3500" _null_ _null_ _null_ _null_ _null_ cdblegacyhash_anyenum _null_ _null_ _null_ n a ));
DESCR("Legacy cdbhash function");
