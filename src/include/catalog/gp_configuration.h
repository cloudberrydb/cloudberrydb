...
/* TIDYCAT_BEGINDEF
   ...
   with (camelcase=GpConfigHistory, shared=true, oid=false, relid=5006, content=MASTER_ONLY)
   (
...
/* TIDYCAT_BEGINDEF
   ...
   with (camelcase=GpDbInterfaces, shared=true, oid=false, relid=5029, content=MASTER_ONLY)
   (
   dbid           smallint,
...
/* TIDYCAT_BEGINDEF
   ...
   with (shared=true, oid=false, relid=5030, content=MASTER_ONLY)
   (
   interfaceid  smallint,
   address      name,
   status       smallint 
