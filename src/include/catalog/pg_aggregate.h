...
/* avg */
DATA(insert ( 2100	n 0 int8_avg_accum	numeric_avg		-					-	-	-	f f 0	2281	128		0	0	_null_ _null_ ));
DATA(insert ( 2101	n 0 int4_avg_accum	int8_avg		int8_avg_amalg		-	-	-	f f 0	17		0		0	0	"" _null_ ));
DATA(insert ( 2102	n 0 int2_avg_accum	int8_avg		int8_avg_amalg		-	-	-	f f 0	17		0		0	0	"" _null_ ));
DATA(insert ( 2103	n 0 numeric_avg_accum	numeric_avg -					-	-	-	f f 0	2281	128		0	0	_null_ _null_ ));
DATA(insert ( 2104	n 0 float4_avg_accum float8_avg		float8_avg_amalg 	-	-	-	f f 0	17		0		0	0	"" _null_ ));
DATA(insert ( 2105	n 0 float8_avg_accum float8_avg		float8_avg_amalg	-	-	-	f f 0	17		0		0	0	"" _null_ ));
DATA(insert ( 2106	n 0 interval_accum  interval_avg	interval_amalg		-	-	-	f f 0	1187	0		0	0	"{0 second,0 second}" _null_ ));

/* sum */
DATA(insert ( 2107	n 0 int8_avg_accum	numeric_sum		-					-	-	-	f f 0	2281	128		0	0	_null_ _null_ ));
DATA(insert ( 2108	n 0 int4_sum		-				int8pl				-	-	-	f f 0	20		0		0	0	_null_ _null_ ));
DATA(insert ( 2109	n 0 int2_sum		-				int8pl				-	-	-	f f 0	20		0		0	0	_null_ _null_ ));
...
DATA(insert ( 2112	n 0 cash_pl			-				cash_pl				-	-	-	f f 0	790		0		0	0	_null_ _null_ ));
DATA(insert ( 2113	n 0 interval_pl		-				interval_pl			-	-	-	f f 0	1186	0		0	0	_null_ _null_ ));
DATA(insert ( 2114	n 0 numeric_avg_accum numeric_sum	-					-	-	-	f f 0	2281	128		0	0	_null_ _null_ ));
...
/* count */
DATA(insert ( 2147	n 0 int8inc_any		-				int8pl				-	-	-	f f 0		20		0		0	0	"0" _null_ ));
DATA(insert ( 2803	n 0 int8inc			-				int8pl				-	-	-	f f 0		20		0		0	0	"0" _null_ ));

/* var_pop */
DATA(insert ( 2718	n 0 int8_accum		numeric_var_pop	-					-	-	-	f f 0		2281	128		0	0	_null_ _null_ ));
DATA(insert ( 2719	n 0 int4_accum		numeric_var_pop	-					-	-	-	f f 0		2281	128		0	0	_null_ _null_ ));
DATA(insert ( 2720	n 0 int2_accum		numeric_var_pop	-					-	-	-	f f 0		2281	128		0	0	_null_ _null_ ));
...
DATA(insert ( 2723	n 0 numeric_accum	numeric_var_pop	-					-	-	-	f f 0		2281	128		0	0	_null_ _null_ ));

/* var_samp */
DATA(insert ( 2641	n 0 int8_accum		numeric_var_samp	-				-	-	-	f f 0		2281	128		0	0	_null_ _null_ ));
DATA(insert ( 2642	n 0 int4_accum		numeric_var_samp	-				-	-	-	f f 0		2281	128		0	0	_null_ _null_ ));
DATA(insert ( 2643	n 0 int2_accum		numeric_var_samp	-				-	-	-	f f 0		2281	128		0	0	_null_ _null_ ));
...
DATA(insert ( 2646	n 0 numeric_accum 	numeric_var_samp	-				-	-	-	f f 0		2281	128		0	0	_null_ _null_ ));

/* variance: historical Postgres syntax for var_samp */
DATA(insert ( 2148	n 0 int8_accum		numeric_var_samp	-				-	-	-	f f 0		2281	128		0	0	_null_ _null_ ));
DATA(insert ( 2149	n 0 int4_accum		numeric_var_samp	-				-	-	-	f f 0		2281	128		0	0	_null_ _null_ ));
DATA(insert ( 2150	n 0 int2_accum		numeric_var_samp	-				-	-	-	f f 0		2281	128		0	0	_null_ _null_ ));
...
DATA(insert ( 2153	n 0 numeric_accum	numeric_var_samp	-				-	-	-	f f 0		2281	128		0	0	_null_ _null_ ));

/* stddev_pop */
DATA(insert ( 2724	n 0 int8_accum		numeric_stddev_pop	-				-	-	-	f f 0		2281	128		0	0	_null_ _null_ ));
DATA(insert ( 2725	n 0 int4_accum		numeric_stddev_pop	-				-	-	-	f f 0		2281	128		0	0	_null_ _null_ ));
DATA(insert ( 2726	n 0 int2_accum		numeric_stddev_pop	-				-	-	-	f f 0		2281	128		0	0	_null_ _null_ ));
...
DATA(insert ( 2729	n 0 numeric_accum	numeric_stddev_pop	-				-	-	-	f f 0		2281	128		0	0	_null_ _null_ ));

/* stddev_samp */
DATA(insert ( 2712	n 0 int8_accum		numeric_stddev_samp	-				-	-	-	f f 0		2281	128		0	0	_null_ _null_ ));
DATA(insert ( 2713	n 0 int4_accum		numeric_stddev_samp	-				-	-	-	f f 0		2281	128		0	0	_null_ _null_ ));
DATA(insert ( 2714	n 0 int2_accum		numeric_stddev_samp	-				-	-	-	f f 0		2281	128		0	0	_null_ _null_ ));
...
DATA(insert ( 2717	n 0 numeric_accum	numeric_stddev_samp	-				-	-	-	f f 0		2281	128		0	0	_null_ _null_ ));

/* stddev: historical Postgres syntax for stddev_samp */
DATA(insert ( 2154	n 0 int8_accum		numeric_stddev_samp	-				-	-	-	f f 0		2281	128		0	0	_null_ _null_ ));
DATA(insert ( 2155	n 0 int4_accum		numeric_stddev_samp	-				-	-	-	f f 0		2281	128		0	0	_null_ _null_ ));
DATA(insert ( 2156	n 0 int2_accum		numeric_stddev_samp	-				-	-	-	f f 0		2281	128		0	0	_null_ _null_ ));
...
DATA(insert ( 2159	n 0 numeric_accum	numeric_stddev_samp	-				-	-	-	f f 0		2281	128		0	0	_null_ _null_ ));
