...
#define Anum_pg_aggregate_aggprelimfn		5
...
/* avg */
DATA(insert ( 2100	n 0 int8_avg_accum	int8_avg_amalg int8_avg	f 0 17 ""));
DATA(insert ( 2101	n 0 int4_avg_accum	int8_avg_amalg int8_avg	f 0 17 ""));
DATA(insert ( 2102	n 0 int2_avg_accum	int8_avg_amalg int8_avg	f 0 17 ""));
DATA(insert ( 2103	n 0 numeric_avg_accum  numeric_avg_amalg numeric_avg f 0	17 ""));
DATA(insert ( 2104	n 0 float4_avg_accum float8_avg_amalg float8_avg	f 0 17 ""));
DATA(insert ( 2105	n 0 float8_avg_accum float8_avg_amalg float8_avg	f 0 17 ""));
DATA(insert ( 2106	n 0 interval_accum  interval_amalg interval_avg	f 0	1187	"{0 second,0 second}"));
...
/* var_pop */
DATA(insert ( 2718	n 0 int8_accum		numeric_amalg	numeric_var_pop	f 0	1231	"{0,0,0}"));
DATA(insert ( 2719	n 0 int4_accum		numeric_amalg	numeric_var_pop	f 0	1231	"{0,0,0}"));
DATA(insert ( 2720	n 0 int2_accum		numeric_amalg	numeric_var_pop	f 0	1231	"{0,0,0}"));
DATA(insert ( 2721	n 0 float4_accum	float8_amalg	float8_var_pop	f 0	1022	"{0,0,0}"));
DATA(insert ( 2722	n 0 float8_accum	float8_amalg	float8_var_pop	f 0	1022	"{0,0,0}"));
DATA(insert ( 2723	n 0 numeric_accum	numeric_amalg	numeric_var_pop	f 0	1231	"{0,0,0}"));

/* var_samp */
DATA(insert ( 2641	n 0 int8_accum		numeric_amalg	numeric_var_samp	f 0	1231	"{0,0,0}"));
DATA(insert ( 2642	n 0 int4_accum		numeric_amalg	numeric_var_samp	f 0	1231	"{0,0,0}"));
DATA(insert ( 2643	n 0 int2_accum		numeric_amalg	numeric_var_samp	f 0	1231	"{0,0,0}"));
DATA(insert ( 2644	n 0 float4_accum	float8_amalg	float8_var_samp	f 0	1022	"{0,0,0}"));
DATA(insert ( 2645	n 0 float8_accum	float8_amalg	float8_var_samp	f 0	1022	"{0,0,0}"));
DATA(insert ( 2646	n 0 numeric_accum 	numeric_amalg	numeric_var_samp	f 0	1231	"{0,0,0}"));

/* variance: historical Postgres syntax for var_samp */
DATA(insert ( 2148	n 0 int8_accum		numeric_amalg	numeric_var_samp	f 0	1231	"{0,0,0}"));
DATA(insert ( 2149	n 0 int4_accum		numeric_amalg	numeric_var_samp	f 0	1231	"{0,0,0}"));
DATA(insert ( 2150	n 0 int2_accum		numeric_amalg	numeric_var_samp	f 0	1231	"{0,0,0}"));
DATA(insert ( 2151	n 0 float4_accum	float8_amalg	float8_var_samp	f 0	1022	"{0,0,0}"));
DATA(insert ( 2152	n 0 float8_accum	float8_amalg	float8_var_samp	f 0	1022	"{0,0,0}"));
DATA(insert ( 2153	n 0 numeric_accum	numeric_amalg	numeric_var_samp	f 0	1231	"{0,0,0}"));

/* stddev_pop */
DATA(insert ( 2724	n 0 int8_accum		numeric_amalg	numeric_stddev_pop	f 0	1231	"{0,0,0}"));
DATA(insert ( 2725	n 0 int4_accum		numeric_amalg	numeric_stddev_pop	f 0	1231	"{0,0,0}"));
DATA(insert ( 2726	n 0 int2_accum		numeric_amalg	numeric_stddev_pop	f 0	1231	"{0,0,0}"));
DATA(insert ( 2727	n 0 float4_accum	float8_amalg	float8_stddev_pop		f 0	1022	"{0,0,0}"));
DATA(insert ( 2728	n 0 float8_accum	float8_amalg	float8_stddev_pop		f 0	1022	"{0,0,0}"));
DATA(insert ( 2729	n 0 numeric_accum	numeric_amalg	numeric_stddev_pop	f 0	1231	"{0,0,0}"));

/* stddev_samp */
DATA(insert ( 2712	n 0 int8_accum		numeric_amalg	numeric_stddev_samp	f 0	1231	"{0,0,0}"));
DATA(insert ( 2713	n 0 int4_accum		numeric_amalg	numeric_stddev_samp	f 0	1231	"{0,0,0}"));
DATA(insert ( 2714	n 0 int2_accum		numeric_amalg	numeric_stddev_samp	f 0	1231	"{0,0,0}"));
DATA(insert ( 2715	n 0 float4_accum	float8_amalg	float8_stddev_samp	f 0	1022	"{0,0,0}"));
DATA(insert ( 2716	n 0 float8_accum	float8_amalg	float8_stddev_samp	f 0	1022	"{0,0,0}"));
DATA(insert ( 2717	n 0 numeric_accum	numeric_amalg	numeric_stddev_samp	f 0	1231	"{0,0,0}"));

/* stddev: historical Postgres syntax for stddev_samp */
DATA(insert ( 2154	n 0 int8_accum		numeric_amalg	numeric_stddev_samp	f 0	1231	"{0,0,0}"));
DATA(insert ( 2155	n 0 int4_accum		numeric_amalg	numeric_stddev_samp	f 0	1231	"{0,0,0}"));
DATA(insert ( 2156	n 0 int2_accum		numeric_amalg	numeric_stddev_samp	f 0	1231	"{0,0,0}"));
DATA(insert ( 2157	n 0 float4_accum	float8_amalg	float8_stddev_samp	f 0	1022	"{0,0,0}"));
DATA(insert ( 2158	n 0 float8_accum	float8_amalg	float8_stddev_samp	f 0	1022	"{0,0,0}"));
DATA(insert ( 2159	n 0 numeric_accum	numeric_amalg	numeric_stddev_samp	f 0	1231	"{0,0,0}"));
