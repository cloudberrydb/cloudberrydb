...
/* sum */
DATA(insert ( 2107	n 0 int8_avg_accum	numeric_sum		-					int8_avg_accum		int8_accum_inv		numeric_sum		f f 0	2281	128		0		0	_null_ _null_ ));
...
/* var_samp */
DATA(insert ( 2641	n 0 int8_accum		numeric_var_samp	-				int8_accum			int8_accum_inv		numeric_var_pop	f f 0		2281	128		2281	128	_null_ _null_ ));
DATA(insert ( 2642	n 0 int4_accum		numeric_var_samp	-				int4_accum			int4_accum_inv		numeric_var_pop	f f 0		2281	128		2281	128	_null_ _null_ ));
DATA(insert ( 2643	n 0 int2_accum		numeric_var_samp	-				int2_accum			int2_accum_inv		numeric_var_pop	f f 0		2281	128		2281	128	_null_ _null_ ));
...
DATA(insert ( 2646	n 0 numeric_accum 	numeric_var_samp	-				numeric_accum		numeric_accum_inv	numeric_var_pop	f f 0		2281	128		2281	128	_null_ _null_ ));
