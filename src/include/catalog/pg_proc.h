...
DATA(insert OID = 2918 ( interval_interval_div  PGNSP PGUID 12 f f t f i 2 701 f "1186 1186" _null_ _null_ _null_ interval_interval_div - _null_ n ));
DESCR("divide");

/* interval_interval_mod("interval", "interval") => "interval" */ 
DATA(insert OID = 2919 ( interval_interval_mod  PGNSP PGUID 12 f f t f i 2 1186 f "1186 1186" _null_ _null_ _null_ interval_interval_mod - _null_ n ));
DESCR("modulus");
...
DATA(insert OID = 1387 ( pg_get_constraintdef  PGNSP PGUID 12 f f t f s 1 25 f "26" _null_ _null_ _null_ pg_get_constraintdef - _null_ n ));
...
DATA(insert OID = 2508 ( pg_get_constraintdef  PGNSP PGUID 12 f f t f s 2 25 f "26 16" _null_ _null_ _null_ pg_get_constraintdef_ext - _null_ n ));
...
DATA(insert OID = 2916 ( generate_series  PGNSP PGUID 12 f f t t v 3 1114 f "1114 1114 1186" _null_ _null_ _null_ generate_series_timestamp - _null_ n ));
DESCR("non-persistent series generator");

/* generate_series("timestamptz", "timestamptz", "interval") => SETOF "timestamptz" */ 
DATA(insert OID = 2917 ( generate_series  PGNSP PGUID 12 f f t t v 3 1184 f "1184 1184 1186" _null_ _null_ _null_ generate_series_timestamptz - _null_ n ));
DESCR("non-persistent series generator");
