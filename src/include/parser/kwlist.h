...
PG_KEYWORD("cpu_hard_quota_limit", CPU_HARD_QUOTA_LIMIT, UNRESERVED_KEYWORD, BARE_LABEL)
PG_KEYWORD("cpu_soft_priority", CPU_SOFT_PRIORITY, UNRESERVED_KEYWORD, BARE_LABEL)
