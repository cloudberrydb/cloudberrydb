...
CREATE INDEX num_exp_add_idx ON num_exp_add (id1, id2);
CREATE INDEX num_exp_sub_idx ON num_exp_sub (id1, id2);
CREATE INDEX num_exp_div_idx ON num_exp_div (id1, id2);
CREATE INDEX num_exp_mul_idx ON num_exp_mul (id1, id2);
CREATE INDEX num_exp_sqrt_idx ON num_exp_sqrt (id);
CREATE INDEX num_exp_ln_idx ON num_exp_ln (id);
CREATE INDEX num_exp_log10_idx ON num_exp_log10 (id);
CREATE INDEX num_exp_power_10_ln_idx ON num_exp_power_10_ln (id);
