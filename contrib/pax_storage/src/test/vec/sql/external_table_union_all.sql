...
location ('file://i-ihu7kfje/code/hashdata-lightning/contrib/pax_storage/src/test/vec/data/location1.csv', 'file://i-ihu7kfje/code/hashdata-lightning/contrib/pax_storage/src/test/vec/data/location2.csv', 'file://i-ihu7kfje/code/hashdata-lightning/contrib/pax_storage/src/test/vec/data/location3.csv')
ON ALL FORMAT 'text';
CREATE EXTERNAL TABLE one_external_table(a INTEGER)
location ('file://i-ihu7kfje/code/hashdata-lightning/contrib/pax_storage/src/test/vec/data/location2.csv')
