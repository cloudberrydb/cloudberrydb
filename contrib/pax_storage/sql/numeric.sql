...
create table pax_vec_numeric_tbl1 (v numeric) using pax with(numeric_vec_storage=true);
create table pax_vec_numeric_tbl2 (v numeric(100)) using pax with(numeric_vec_storage=true);
create table pax_vec_numeric_tbl3 (v numeric(36,36)) using pax with(numeric_vec_storage=true);

create table pax_vec_numeric_tbl (v numeric(35,0)) using pax with(numeric_vec_storage=true);
...
create table pax_vec_numeric_tbl (v numeric(35,35)) using pax with(numeric_vec_storage=true);
...
create table pax_vec_numeric_tbl (v numeric(35,17)) using pax with(numeric_vec_storage=true);
...
-- without option `numeric_vec_storage`, pax should store numeric as non fixed column

create table pax_numeric_tbl1 (v numeric) using pax with(numeric_vec_storage=false);
