...
CWDIR=${CBDB_PATH}/concourse/scripts
source "${CWDIR}/common.bash"

function install_ext() {
	echo "start install contrib..."
	pushd ${CBDB_PATH}/contrib
	make install
	echo "end install contrib..."
	popd

	echo "start install gpcontrib..."
	pushd ${CBDB_PATH}/gpcontrib
	make install
	echo "end install gpcontrib..."
	popd
}
