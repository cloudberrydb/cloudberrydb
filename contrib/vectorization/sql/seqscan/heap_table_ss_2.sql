...
CREATE TABLE IF NOT EXISTS t1 (a INT, b TEXT, c VARCHAR(20)) DISTRIBUTED BY(a);
CREATE TABLE IF NOT EXISTS t2 (a INT, b TEXT, c VARCHAR(20)) DISTRIBUTED RANDOMLY;
CREATE TABLE IF NOT EXISTS t3 (a INT, b TEXT, c VARCHAR(20)) DISTRIBUTED REPLICATED;
