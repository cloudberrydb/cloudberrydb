...
CREATE TABLE T(pk INT NOT NULL, c_int INT DEFAULT 1);
...
CREATE TABLE T(pk INT NOT NULL, c_int INT DEFAULT LENGTH(foo(6)));
...
CREATE TABLE T(pk INT NOT NULL);
...
CREATE TABLE t (id serial, a int, b int, c int);
...
CREATE TABLE leader (a int, b int);
