...
CREATE TABLE truncate_a (col1 integer) DISTRIBUTED BY (col1);
...
CREATE TABLE trunc_c (a serial) DISTRIBUTED BY (a);
...
CREATE TABLE trunc_f (col1 integer);
...
CREATE TABLE trunc_a (a INT) PARTITION BY RANGE (a);
