...
create temp table zt1 (f1 int);
create temp table zt2 (f2 int);
create temp table zt3 (f3 int);
...
CREATE TEMP TABLE a (id int, b_id int);
CREATE TEMP TABLE b (id int, c_id int);
...
create temp table parent (k int, pd int);
create temp table child (k int, cd int);
...
CREATE TEMP TABLE b (id int, a_id int);
...
create temp table innertab (id int8, dat1 int8);
...
create temp table parttbl (a integer) partition by range (a);
...
create table fkest (a int, b int, c int);
create index fkest_c_key on fkest (c);
create table fkest1 (a int, b int);
...
create table j1 (id1 int, id2 int);
create table j2 (id1 int, id2 int);
create table j3 (id1 int, id2 int);
