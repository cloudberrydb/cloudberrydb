...
CREATE TABLE base_tbl (a int, b text DEFAULT 'Unspecified');
...
CREATE TABLE base_tbl (a int, b text DEFAULT 'Unspecified', c serial);
...
CREATE TABLE base_tbl(id int, data text, deleted boolean);
...
create table uv_iocu_tab (a text, b float);
