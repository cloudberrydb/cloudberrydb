...
-- GPDB needs to allocate metapage on all segments.
INSERT INTO clean_aborted_self (key, data) SELECT g.i, 'just to allocate metapage' FROM generate_series(-10, -1) g(i);
