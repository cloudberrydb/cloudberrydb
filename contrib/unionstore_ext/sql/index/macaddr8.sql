set default_index_access_method=usbtree;
--
-- macaddr8
--
...
CREATE INDEX macaddr8_data_btree ON macaddr8_data using usbtree (b);
CREATE INDEX macaddr8_data_hash ON macaddr8_data using ushash (b);
