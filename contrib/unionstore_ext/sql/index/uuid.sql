...
CREATE INDEX guid1_btree ON guid1 using usbtree (guid_field);
CREATE INDEX guid1_hash  ON guid1 using ushash  (guid_field);

-- unique index test
CREATE UNIQUE INDEX guid1_unique_BTREE ON guid1 using usbtree (guid_field);
-- should fail
INSERT INTO guid1(guid_field) VALUES('11111111-1111-1111-1111-111111111111');
