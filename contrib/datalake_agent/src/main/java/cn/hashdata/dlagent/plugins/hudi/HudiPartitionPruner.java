 ...
 */
public class HudiPartitionPruner {
  ...
  public static class DynamicPartitionPruner implements PartitionPruner {
    private final ExpressionEvaluators.Evaluator partitionEvaluator;

    private final String[] partitionKeys;

    private final List<Type.TypeID> partitionTypes;
    ...
    private DynamicPartitionPruner(
        ...
        List<Type.TypeID> partitionTypes,
    ...
    private boolean evaluate(String partition) {
      ...
      return partitionEvaluator.eval(partStats);
    }
  }
  ...
  public static PartitionPruner getInstance(
      ...
      String defaultParName,
      boolean hivePartition) {
    ValidationUtils.checkState(partitionEvaluator != null);
    return new DynamicPartitionPruner(partitionEvaluator, partitionKeys, partitionTypes, defaultParName, hivePartition);
  }
